              ...
              <div class="swiper-slide swiper-slide-active">                
					<div class="box">
						...
						<div class="cardBottom">
								...
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB&game_type=SL&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PN"><img src="/bbindz.jpg"></a>
						</div>
					</div>
               </div>
            </div>
              ...
              <div class="swiper-slide swiper-slide-active">                
					<div class="box">
						...
						<div class="cardBottom">
								...
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=S6&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="S6"><img src="/bbin.jpg"></a>
								...
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GB"><img src="/sexy.jpg"></a>
              ...
              <div class="swiper-slide swiper-slide-active">                
				  	<div class="box">
						...
						<div class="cardBottom">
								...
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=KY&game_type=&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="KY"><img src="/KY.png"></a>
						</div>
					</div>
               </div>
            </div>
