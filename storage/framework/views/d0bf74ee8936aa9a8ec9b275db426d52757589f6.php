    ...
    <div class="row apiList clearfix">
        <div class="col-xs-2">
            <div class="text-center">
                ...
                <button class="btn btn-primary btn-danger" id="jiaoban">交班</button>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <p style="float:left;width: 50%;"><?php echo e(@$admin_log->createtime); ?>交班</p>
                        <p style="float:right;width: 50%;">总充值：<?php echo e(@$admin_log->recharge); ?></p>
                        <p style="float:left;width: 50%;">总红利：<?php echo e(@$admin_log->dividend); ?></p>
                        <p style="float:right;width: 50%;">总提现：<?php echo e(@$admin_log->drawing); ?></p>
                        <p style="float:left;width: 50%;">代理佣金：<?php echo e(@$admin_log->daili); ?></p>
                        
                        
                        
                        <p style="float:right;width: 50%;">盈利：<?php echo e(@$admin_log->recharge- @$admin_log->drawing); ?></p>
                        <p style="clear:both;"></p>
                    </div>
                    <div class="icon">
                        
                    </div>
                    <a href="/admin/jiaobanlist" class="small-box-footer">查看详情 <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    <div class="inner">
                        <p style="float:left;width: 50%;"><?php echo date('m');?>月份报表</p>
                        <p style="float:right;width: 50%;">当月总充值：<?php echo e(@$month['month_recharge']); ?></p>
                        <p style="float:left;width: 50%;">当月总红利：<?php echo e(@$month['month_dividend']); ?></p>
                        <p style="float:right;width: 50%;">当月总提现：<?php echo e(@$month['month_drawing']); ?></p>
                        <p style="float:left;width: 50%;">当月代理佣金：<?php echo e(@$month['daili']); ?></p>
                        
                        
                        
                        <p style="float:right;width: 50%;">盈利：<?php echo e(@$month['month_recharge']-$month['month_drawing']); ?></p>
                        <p style="clear:both;"></p>
                    </div>
                    <div class="icon">
...
//                 var money_span = _this.parent('p').next().find('span');
        ...
        $('#jiaoban').click(function(){
            layer.msg('选择当前班次', {
                ...
                btn: ['晚班', '白班'],
                yes:function(){
                    layer.confirm('确定<font color="#3c8dbc">晚班</font>交班吗？', {
                      btn: ['确定','取消'] //按钮
                    }, function(){
                        $.ajax({
                            url:'/admin/jiaoban',
                ...
                btn2:function(){
                    layer.confirm('确定<font color="#d73925">白班</font>交班吗？', {
                      btn: ['确定','取消'] //按钮
                    }, function(){
                        $.ajax({
                            url:'/admin/jiaoban',
