                ...
                <div class="panel-body">
                                ...
                                <div class="col-lg-2">
                                    <div class="input-group">
                                        ...
                                        <select name="api_type" id="api_type" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $_api_list_1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table class="table table-bordered table-hover text-center">
                        <tr>
                            ...
                            <th style="width: 8%">平台账号</th>
                            <th style="width: 5%">平台名称</th>
                            <th style="width: 4%">游戏类别</th>
                            <th style="width: 8%">输赢情况</th>
                            <th style="width: 8%">下注金额</th>
							 <th style="width: 5%">有效下注</th>
                            <th style="width: 8%">游戏名称</th>
