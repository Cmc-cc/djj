...
<div class="nytop">
	...
	<h2><a href="<?php echo e($setting->service_link); ?>"><?php echo e(trans("lang.zxkf")); ?></a></h2>
</div>
	...
	<div class="drawInfor">
			    ...
			    <div class="bankBox1">
					...
					每日首充赠送<?php echo e($setting->sc_percent); ?>%（本金倍+送分<?php echo e($setting->hongli_ml_percent); ?>倍碼量）
					 ...
					 <?php if($_member->is_new2): ?>
						<div class="">
					新账号首充赠送<?php echo e($setting->new_sc_percent); ?>%（本金倍+送分<?php echo e($setting->hongli_new_percent); ?>倍碼量）
       ...
       <!--                     <?php endif; ?>-->
       <!--                     <?php if($_member->is_new2): ?>-->
       <!--                     <option value="3">新账号首充赠送<?php echo e($setting->new_sc_percent); ?>%（本金倍+送分<?php echo e($setting->hongli_new_percent); ?>倍碼量）</option>-->
       <!--                     <?php endif; ?>-->
       <!--         </select>-->
			    <!--<p style="float:right;margin-right:1rem;">.<?php echo e($xiaoshu); ?> <?php echo e(trans("lang.yuan")); ?></p>-->
			</li>
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		<p class="row account">
        			...
        			<span class="chatNumber2" style="color:#fb2464 ;"><?php echo e($_system_config->qq_account); ?></span>
        		...
        		<p class="row banker">
        			<span class="asain"><?php echo e(trans("lang.skzh")); ?>：</span>
        			<span class="chatNumber3" style="color:#fb2464 ;"><?php echo e($_system_config->qq_nickname); ?></span>
        		...
        		<div class="btns" >
        			...
        			<button type="button" class="submit ajax-submit-without-confirm-btn switchroute" onclick="addrecharge()"><?php echo e(trans("lang.qrcz")); ?></button>
        		</div>
        	</div>
...
function step(){
    	...
    	$.ajax({
			type:"post",
			url:"<?php echo e(route('wap.chongzhi')); ?>",
...
<script>
	...
	$(".singleimg").change(function(){
                            ...
                            if (this.files.length>1) {
                                layer.open({
                                    content: '<?php echo e(trans("lang.zdyz")); ?>'
                                    ,skin: 'msg'
                                    ,time: 1 //2秒后自动关闭
                                });
                                return false;
