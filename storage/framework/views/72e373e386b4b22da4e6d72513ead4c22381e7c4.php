...
<link type="text/css" rel="stylesheet" href="/new/css/public.css?v=20230828">
<div class="m_container">

	<div class="nytop" style="position: fixed;top:0;width: 100%;z-index: 999;">
		<!-- <a href="javascript:history.go(-1);" class="fhbtn"></a> -->
		<h2><a href="/m" style="left: .3rem;">首頁</a></h2>
		<h1><?php echo e(trans("lang.czjl")); ?></h1>
	</div>

	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;z-index: 999;">
		<a href="/m/recharge_record"><div class="acse ">存款</div></a>
		<a href="/m/drawing_record"><div class="acse as">提現</div></a>
		<a href="/m/game_record"><div class="acse">投注</div></a>
		<a href="/m/user_fsjl"><div class="acse">返水</div></a>
		<!--<a href="/m/transfer_record"><div class="acse">额度转换</div></a>-->
	</div>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;">
                <p style="width: 16%" tid="1" class="on" onclick="qiehua(1,this)"><?php echo e(trans("lang.jinri")); ?></p>
                <p style="width: 15.5%" tid="2" onclick="qiehua(2,this)">2<?php echo e(trans("lang.day")); ?></p>
				<p style="width: 15.5%" tid="3" onclick="qiehua(3,this)">3<?php echo e(trans("lang.day")); ?></p>
				<p style="width: 15.5%" tid="5" onclick="qiehua(5,this)">5<?php echo e(trans("lang.day")); ?></p>
                <p style="width: 18%" tid="7" onclick="qiehua(7,this)">7<?php echo e(trans("lang.day")); ?></p>
                <p style="width: 19.5%" tid="30" onclick="qiehua(30,this)">30<?php echo e(trans("lang.day")); ?></p>
            </div>
        </div>
    </div>
			...
			<div class="content">
				<div class="all-info">
					<div class="make-money">
						...
						<h3 id="total">$&nbsp;<?php echo e($total); ?></h3>
					</div>
					<!-- <div class="failure">
						<h3>￥-0.00</h3>
						<p>损益:</p>  
					...
					$(window).scrollTop(0)
						...
						var getUserList={
							...
							get:function () {
								...
								$.ajax({
									url : "/m/drawing_record_api?page="+getUserList.page+'&day='+type,
									type : 'GET',
									...
									success : function (data) {
										if(data.status.errorCode == 0){
											...
											for(let item of data2){
												...
												/*$('#general-msg').append(`<tr class="haveRead MColor1" style="display: table-row;">
														<td style="text-align:center;">`+item.money + `<?php echo e(trans("lang.yuan")); ?></td>
														<td style="text-align:center;">
													` + zhuangtai+`
														</td>
														<td style="text-align:center;">`+ item.created_at +`</td>
													</tr>`)*/
													$('#list').append(`<div class="list" onclick="qiehuan(this)">
														<div class="list-top">
															<div class="list-top1">
															...
															<a href = "javascript:;"   class="qiehuan_a" data-type = "1"></a>
														</div>
