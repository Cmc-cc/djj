     ...
     <section class="content">
         <div class="panel panel-primary">
             ...
             <div class="panel-body">
                 <?php echo $__env->make('admin.send_daili_money.filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                 <form action="<?php echo e(route('send_daili_money.store')); ?>" method="post">
                 <table class="table table-bordered table-hover text-center">
                     ...
                     <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         ...
                         <tr>
                             <td>
                                 <label>
                                     <input type="checkbox" name="top_id[]" value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?>

                                     <input type="hidden" name="yl_money[<?php echo e($item->id); ?>]" value="<?php echo e($total_sy_money); ?>">
                                 </label>
                             </td>
                             <td>
                                 <?php echo e($item->under_members()->count()); ?>

                             </td>
                             <td>
                                 <?php echo e($item->under_members()->sum('money')); ?>

                             </td>
                             <td>
                                 <?php echo e($recharge_money); ?>

                             </td>
                             <td>
                                 <?php echo e($drawing_money); ?>

                             </td>
                             <td>
                                 <?php echo e($dividend_money_1); ?>

                             </td>
                             <td>
                                 <?php echo e($dividend_money_2); ?>

                             </td>
                             <td>
                                 <?php echo e($dividend_money_3); ?>

                             </td>
                             <td></td>
                             <td><?php echo e(isset($item->daili_money_logs()->orderBy('created_at', 'desc')->first()->created_at) ? $item->daili_money_logs()->orderBy('created_at', 'desc')->first()->created_at : '无'); ?></td>
                             <td>
                                 <input type="text" class="form-control" name="money[<?php echo e($item->id); ?>]" value="<?php echo e($total_sy_money*$rate/100); ?>" style="max-width: 80px;">
                             </td>
                             <td>
                                 <button type="button" data-uri="<?php echo e(route('daili_money_log.show_by_id', ['id' => $item->id])); ?>" class="btn btn-info btn-xs show-cate">记录</button>
                                 <textarea name="remark[<?php echo e($item->id); ?>]"  rows="2" class="form-control"></textarea>
                             </td>
                         </tr>
