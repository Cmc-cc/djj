...
<div class="m_container">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;    z-index: 999;">
		<a href="/m/recharge_record"><div class="acse as">存款</div></a>
		<a href="/m/drawing_record"><div class="acse">提現</div></a>
					...
					$(window).scrollTop(0)
						...
						var getUserList={
							...
							get:function () {
								...
								$.ajax({
									url : "/m/recharge_record_api?page="+getUserList.page+'&day='+type,
									type : 'GET',
