...
<div class="m_container">
	...
	<div class="nytop" style="position: fixed;top:0;width: 100%;z-index: 999;">
		...
		<h1><?php echo e(trans("lang.touzhu")); ?></h1>
	</div>
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;z-index: 999;">
		...
		<a href="/m/game_record"><div class="acse as">投注</div></a>
					...
					$(window).scrollTop(0)
						...
						var getUserList={
							...
							get:function () {
								...
								$.ajax({
									url : "/m/game_record_api?page="+getUserList.page+'&day='+type+'&gameCode=0',
									type : 'GET',
											...
											for(let item of data2){
												...
												$('#list').append(`<div class="list" onclick="qiehuan(this)">
														<div class="list-top">
															...
															<a href = "javascript:;" data-type = "1"  class="qiehuan_a"></a>
														</div>
