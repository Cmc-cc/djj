	...
	<div class="drawInfor">
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		<p class="row account">
                    <span class="asain"> TRC20：</span>
        			<span class="chatNumber2" style="color:#fb2464 ;">TT5MUFPzaynTWkfFbGDWCkrjyjiA4KT2h8</span>
        		...
        		<p class="row banker">
        			<span class="asain">二維碼：</span>
        			<img src="/new/img/toanza2606089BB313.png" width="200" height="300" style="margin-left: 0px;margin-top: 0px"/>
        		</p>
        		<div class="btns" >
        			<a class="contact" onclick="window.location.href='/m/usdt'">返回 重新輸入</a>
...
function step(){
    $.ajax({
			...
			data : {money:$('#money').val(),xiaoshu:$('#xiaoshu').val()},
			success : function (data) {
				if(data.status.errorCode == 0){
                     $('#SubTran1').hide();
                    $('.bq2-wrapper').show();
                    $('#paymoney').text(  Number(Number(Number($('#money').val()+'.'+$('#xiaoshu').val()) / <?php echo e($_system_config->usdt_lv); ?>).toFixed(3)));
                    $('#step1').hide();
                }else{
...
function addrecharge() {
			$.ajax({
				...
				data : {amount:$('#money').val(),xiaoshu:$('#xiaoshu').val(),'paytype':'usdt'},
				success : function (data) {
					if(data.status.errorCode == 0){
