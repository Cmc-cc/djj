...
<!--<body class="m_bac" style="background: url(/new/img/quickRegister_bg1.jpg) no-repeat 50% #090913;background-size: cover;">-->
 <body class="m_bac" style="background: url(../images/quickRegister_bg.jpg) no-repeat 50% #090913;background-size: cover"> 
...
<div class="nytop" style="background:none">
  ...
  <h2><a href="<?php echo e(route('wap.login')); ?>">登录</a></h2> 
  <!--<h2><a href="<?php echo e($_system_config -> app_link); ?>" target="_blank"><?php echo e(trans('lang.xzapp')); ?></a></h2>-->
</div>
<div class="loginBox">
    <div class="loginBar1">
        <form method="post" action="<?php echo e(route('wap.register.post')); ?>"  onSubmit="return check_form(this)" id="form1">
        	<ul>
            	<li><input id="regUsername" name="name" type="text" class="user" required="required" minlength="6" maxlength="9" placeholder="<?php echo e(trans('lang.zanghao')); ?>"><i class="line"></i><span class="clearBtn"></span></li>
                ...
                <li class="keywords"><input id="regUserpwd" name="password" required="required" type="password" class="keyword" minlength="6" maxlength="16" placeholder="<?php echo e(trans('lang.qingshuru')); ?><?php echo e(trans('lang.mima')); ?>"><i class="line"></i><span class="eye"></span></li>
                <li class="keywords"><input id="regUserSurepwd" name="password_confirmation"  required="required" type="password" class="keyword" minlength="6" maxlength="16" placeholder="<?php echo e(trans('lang.qingzaicishuru')); ?><?php echo e(trans('lang.mima')); ?> *"><i class="line"></i><span class="eye"></span></li>
                
                <li style="background:url('/new/img/key.png') 0.26rem center / 0.32rem no-repeat #2b2f33;" class="keywords"><input id="regUserWithdrawalsPwd" name="qk_pwd" required="required"  type="password" class="keyword" minlength="6" maxlength="16" placeholder="<?php echo e(trans('lang.qingshuru')); ?><?php echo e(trans('lang.qkmm')); ?> *"><i class="line"></i><span class="eye"></span></li>
                
                <!--<li style="background:url('/new/img/user.png') 0.26rem center / 0.32rem no-repeat #2b2f33;"><input id="username" name="username" type="text" class="user"  placeholder="請輸入真實英文姓名"><i class="line"></i><span class="clearBtn"></span></li>-->
                <?php if($setting->is_real_name_1): ?>
    		        <li style="background:url('/new/img/user.png') 0.26rem center / 0.32rem no-repeat #2b2f33;"><input id="real_name" name="real_name" type="text" class="user"  <?php if($setting->is_real_name_2): ?>   required="required" <?php endif; ?>  placeholder="請輸入真實英文姓名"><i class="line"></i><span class="clearBtn"></span></li>
                <?php endif; ?>
                
                 <?php if($setting->is_phone_1): ?>
    			<li style="background:url('/new/img/a44a2.png') 0.26rem center / 0.32rem no-repeat #2b2f33;"><input id="phone" name="phone" type="tel" class="user" maxlength="16"   <?php if($setting->is_phone_2): ?>   required="required" <?php endif; ?>  placeholder="<?php echo e(trans('lang.qingshuru')); ?><?php echo e(trans('lang.sjh')); ?>*"><i class="line"></i></li>
                <!--<li style="background:url('/new/img/a44a2.png') 0.26rem center / 0.32rem no-repeat #2b2f33;"><input id="code" name="code" type="text" class="user"  <?php if($setting->is_phone_2): ?>   required="required" <?php endif; ?> placeholder="<?php echo e(trans('lang.qingshuru')); ?><?php echo e(trans('lang.yzm')); ?>*" style="width: 50%;"><i class="line"></i><input type="button" id="btn" value="<?php echo e(trans('lang.hqyzm')); ?>" class="sty2 yanzhen"  style="width: 50%;"></li>-->
                <?php else: ?>
                	<!--<li style="background:url('/new/img/a44a2.png') 0.26rem center / 0.32rem no-repeat #2b2f33;"><input id="phone" name="phone" type="tel" class="user" maxlength="8" placeholder="<?php echo e(trans('lang.qingshuru')); ?><?php echo e(trans('lang.sjh')); ?>*"><i class="line"></i></li>-->
                <?php endif; ?>
                
                <?php if($setting->is_email_1): ?>
    		        <li style="background:url('/new/img/email.png') 0.23rem center / 0.42rem no-repeat #2b2f33;"><input id="email" name="email" type="text" class="user"  <?php if($setting->is_email_2): ?>   required="required" <?php endif; ?>  placeholder="请输入邮箱"><i class="line"></i><span class="clearBtn"></span></li>
                <?php endif; ?>
                
                <?php if($setting->is_qq_1): ?>
    		        <li style="background:url('/new/img/qq.png') 0.23rem center / 0.42rem no-repeat #2b2f33;"><input id="qq" name="qq" type="text" class="user"  <?php if($setting->is_qq_2): ?>   required="required" <?php endif; ?>  placeholder="请输入QQ号"><i class="line"></i><span class="clearBtn"></span></li>
                <?php endif; ?>
                
                <?php if($setting->is_weixin_1): ?>
    		        <li style="background:url('/new/img/weixin.png') 0.15rem center / 0.55rem no-repeat #2b2f33;"><input id="weixin" name="weixin" type="text" class="user"  <?php if($setting->is_weixin_2): ?>   required="required" <?php endif; ?>  placeholder="请输入微信号"><i class="line"></i><span class="clearBtn"></span></li>
                <?php endif; ?>
                
                <?php if($setting->is_regtj_1): ?>
    		        <li style="background:url('/new/img/user.png') 0.26rem center / 0.32rem no-repeat #2b2f33;"><input id="t_name" name="t_name" type="text" class="user"  <?php if($setting->is_regtj_2): ?>   required="required" <?php endif; ?>  placeholder="請輸入推荐人"><i class="line"></i><span class="clearBtn"></span></li>
                <?php endif; ?>
...
$('.sty2').click(function(){
	...
	$('#kefu_box').click(function(){
        layer.open({
            content: '<div class="layui-m-layerbtn"><span yes="" type="1" onclick="tapCopy('+"'url_whats'"+')" data-clipboard-target="#url">招募代理Whats: 67604785</span></div>   <div class="layui-m-layerbtn"><a href="<?php echo e($setting->service_link); ?>" target="_blank"><span yes="" type="1"><?php echo e(trans("lang.zxkf")); ?></span></a></div>'
            ,skin: 'footer'
        });
    })
    function wechat(){
