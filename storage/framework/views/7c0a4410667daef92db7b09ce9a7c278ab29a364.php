	...
	<div class="drawInfor">
	    <div class="drawInfor-top">
	        ...
	        <div class="drawInfor-top1">
	            <span>$</span>
	            <h4 class="member_money"><?php echo e($member->money); ?></h4>
	            <i id="trans_all">資金回收</i>
	        </div>
	    </div>
		<ul>
		    <li class="usdttxt2"><span class="usdttxt">收款銀行</span><p><img src="/new/img/yhk.png" /></p>&nbsp;&nbsp;(<?php echo e($_member->bank_card); ?>)&nbsp;&nbsp;<?php
...
?></li>
    ...
    font-weight: bold;
    margin-left: 10px;
}"><?php echo e($member->ml_money); ?></span></li>
		</ul>
		<input type="button" value="<?php echo e(trans('lang.qr')); ?>" class="subBtn ajax-submit-btn" id="subBtn" style="background:linear-gradient(to right, #cead8b , #dec7a7)">
		<div style="color:#fff;line-height:2" class="desc"><?php echo e(trans("lang.tkts")); ?></div>
	</div>
...
<!-- 获取焦点加亮 -->
	...
	$('#subBtn').click(function(){
	    $.ajax({
				...
				data : {code:$('#code').val(),qk_pwd:$('#qk_pwd').val(),money:$('#money').val(),bank_card:'<?php echo e($_member->bank_card); ?>',name:'<?php echo e($_member->name); ?>',bank_name:'<?php echo e($_member->bank_name); ?>'},
