            ...
            <table class="Hyzx-table mt10 MMain">
                ...
                <tbody id="general-msg">
                   <?php if($data->total() > 0): ?>
                    ...
                    <tr id="list<?php echo e($item->id); ?>" class="haveRead MColor1" style="display: table-row;">
                        <td style="text-align:center;width: 150px;" class="mouseenter"><?php echo e($item->created_at); ?></td>
                        <td class="msgdetail mouseenter">
                            <a href="javascript:void(0)" title="详细内容" style="display:block;" onclick="oMsg.processMsg(<?php echo e($item->id); ?>, 1, 'getdetail');" class="mouseenter"><?php echo e($item->title); ?></a>
                        </td>
                        <?php if($item->pivot->is_read): ?>
                        <td style="text-align:center;" class="mouseenter"><span id="islook<?php echo e($item->id); ?>">已读</span></td>
                        <?php else: ?>
                         <td style="text-align:center;" class="mouseenter"><span id="islook<?php echo e($item->id); ?>">未读</span></td>
                       	<?php endif; ?>
                        <td style="text-align:center;" class="mouseenter">
                            <a href="javascript:void(0)" onclick="oMsg.processMsg(<?php echo e($item->id); ?>, 2 ,'delmsg');" class="mouseenter">删除</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-left: 12px; display: none;" width="980" colspan="4">
                            <p id="msg<?php echo e($item->id); ?>" style="display: none;">
...
<!--                                <td style="text-align:center;" onclick="open(show<?php echo e($item->id); ?>)"><?php echo e($item->title); ?></td>-->
...
<!--                                </td>-->
<!--                            </tr>-->
<!--                            <tr class="show<?php echo e($item->id); ?>">-->
<!--                                <td colspan="4">-->
<!--                                    <?php echo e($item->content); ?>-->
<!--                                </td>-->
<!--                            </tr>-->
