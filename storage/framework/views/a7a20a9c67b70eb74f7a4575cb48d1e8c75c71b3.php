...
<html style="font-size:52px !important"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link type="text/css" rel="stylesheet" href="/new/css/style.css?v=202308251">
...
<div class="header" style="display:flex;align-items:center;justify-content:space-between;">
    ...
    <!--style="height: 20px;"-->
     ...
     <!--           <p class="member_money"><?php echo e(@$_member -> money?$_member -> money:'0.00'); ?></p>-->
     <!--         </div>-->
     <!--       <?php if(!Auth::guard('member')->guest()): ?>-->
     <!--       <?php else: ?>-->
     <!--       <?php endif; ?>-->
     ...
     <div class="userChoses">
        <img src="<?php echo e($setting->m_site_logo); ?>">
     </div>
     	<div class="headerNotice" style="display:flex;align-items:center;justify-content:space-between;">
        ...
        <div class="txtMarquee-left">
            ...
            <div class="bd">
                 ...
                 <div class="tempWrap" style="overflow:hidden; position:relative; width:759px">
                    <marquee style="color:#9aa4c2;font-size:.24rem; line-height:.6rem;"><?php echo e($system_notices2->content); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans("lang.zxrs")); ?><?php echo rand(11000,13000)?></marquee>
			...
			<div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-ios">
				<div class="swiper-wrapper" >
					...
					<div class="swiper-slide" data-swiper-slide-index="0" >
						<a><img src="<?php echo e($item->path); ?>" style="border-radius:0.1rem"></a>
					</div>
...
.home-link-bar .tab .tab-right .tab-right-btn .deposit-icon{
    ...
    background-size: 130vmin 20vmin;
	    	...
	    	<div class="tab">
            	<div class="tab-left">
            	 ...
            	 <!--   <div class="onlineusers" style="font-size:14px;">-->
					...
					<div class="moneystyle">
						<span class="mark-txt" style="margin-left:2px;">	<img src="../images/jinbin.png"  style="vertical-align:middle;width:23px;margin-left:0px;margin-top:-3px;display:inline-block">$<text id="gamemoney" class="gamemoney_text"><?php echo e(@$_member -> money?$_member -> money:'0.00'); ?></text></span>
            	...
            	<div class="tab-right">
            			...
            			<div class="tab-right-btn btn-pop" data-pop="withdraw-dialog" onclick="window.location.href='/m/msg'">
            				...
            				<h4 style="color:#b1987f; font-size: 3vmin; font-weight: 400;" class="icon4"><?php echo e(trans("lang.xiaoxi")); ?></h4>
            				<h4 style="height: 3vmin;"></h4>
            			</div>
                        <?php else: ?>
...
.noticeAltbox-bottom{ display:flex; justify-content:center; flex-wrap:wrap; padding:10px 0;}
	...
	<div class="gameList">
	    	<div class="gameControl" style="display:flex;
	    	align-items:center;">
    ...
    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
        <!--height: 331px;-->
      <div class="swiper-slide swiper-slide-active" style="height: 10rem;">
              ...
              <div class="swiper-slide swiper-slide-active">                
					<div class="box">
						...
						<div class="cardBottom">
								<a class="toplay2" <?php if($_member): ?> data-url="/game/playGame?plat_type=JK&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JK"><img src="/JOKER.png"></a>
								
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JD&game_type=SL&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JD"><img src="/JDB.png"></a>
								
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=PG&game_type=SL&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PG"><img src="/PG.png"></a>
								
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=CQ&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="CQ"><img src="/LIVE22.png"></a>
								
								<!--<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=PS&game_type=&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PS"><img src="/yg.png"></a>-->
								
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=PN&game_type=3&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="PN"><img src="/png.png"></a>
								
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB&game_type=SL&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GB"><img src="/bbindz.jpg"></a>
						</div>
					</div>
               </div>
            </div>
     ...
     <!--         <div class="swiper-slide swiper-slide-active">                -->
					...
					<!--			<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=DG&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="DG"><img src="/DG.png"></a>-->
					<!--			<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=S6&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="S6"><img src="/sexy.jpg"></a>-->
															
					<!--			<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=WC&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="WC"><img src="/WM.png"></a>-->
															
					<!--			<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="GB"><img src="/bbin.jpg"></a>-->
					<!--			<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=E0&game_type=1&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="E0"><img src="/evosx.png"></a>-->
              ...
              <div class="swiper-slide swiper-slide-active">                
				  	<div class="box">
						...
						<div class="cardBottom">
								...
								<!--<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=KY&game_type=&game_code=CB&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="KY"><img src="/KY.png"></a>-->
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=NP&game_type=&game_code=CB&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="NP"><img src="/KY.png"></a>
								<!--<a onclick="alert('维护中')"><img src="/KY.png"></a>-->
						</div>
					</div>
               </div>
            </div>
            ...
            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
              <div class="swiper-slide swiper-slide-active">                
					<div class="box">
						...
						<div class="cardBottom">
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=S3&game_type=5&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="S3"><img src="/wap/theme10/images/sbo1.png"></a>
															
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=ST&game_type=5&game_code=&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="ST"><img src="/wap/theme10//images/crown.png"></a>
              ...
              <div class="swiper-slide swiper-slide-active">                
					<div class="box">
						...
						<div class="cardBottom">
								...
								<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JK&game_type=FH&devices=1" <?php else: ?> data-url="" <?php endif; ?> data-code="JK"><img src="/JOKER.png"></a>
								<!--<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=JD&game_type=FH&devices=1" <?php else: ?> data-url="" <?php endif; ?>  data-code="GB"><img src="/JDB.png"></a>-->
								<!--<a class="toplay" <?php if($_member): ?> data-url="/game/playGame?plat_type=GB&game_type=FH&devices=1" <?php else: ?> data-url="" <?php endif; ?>  data-code="GB"><img src="/bbindz.jpg"></a>-->
...
var mySwiper1 = new Swiper('#swiper-container1', {
    ...
    <?php $__currentLoopData = $api_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <span class="gamecode" data-code="<?php echo e($item->api_name); ?>"></span>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
...
<div class="noticeAltbox noticeAltbox1" style="display: none;">
		...
		<div class="formAlt">
			<div class="lastMoney">
				<p>當前余額：<span id="lesNum"><?php echo e(@$_member->money); ?></span></p>
...
<div class="noticeAltbox noticeAltbox2">
	...
	//弹出图片
	var is_alert_on = '<?php echo e($setting->is_alert_on); ?>'
	var resourcesUrl = '<?php echo e($setting->alert_img); ?>'
	var resourcesType = 1;
	if(is_alert_on==0){
  ...
  // resourcesUrl：接受的图片地址，resourcesType之前定义的数据类型（可省略）
    ...
    $('body').on('click','.kefu_box',function(){
        layer.open({
            content: '   <div class="layui-m-layerbtn"><a href="<?php echo e($setting->service_link); ?>" target="_blank"><span yes="" type="1"><?php echo e(trans("lang.zxkf")); ?></span></a></div>'
            ,skin: 'footer'
        });
    })
    function wechat(){
    ...
    <?php if($gonggao==1): ?>
        ...
        //     layer.open({
        //         title: [
        //           "<?php echo e(trans('lang.xtgg')); ?>",
        //           "background-color: #0b93ae; color:#fff;"
        //         ]
        //         ,content: '<?php echo e($system_notices2->content); ?>'
        //     });
