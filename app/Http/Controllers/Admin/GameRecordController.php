...
class GameRecordController extends AdminBaseController
{
    ...
    {
        $mod = new GameRecord();
        $playerName = $start_at = $end_at = $api_type = $gameType = $flag ='';
        ...
        return view('admin.game_record.index', compact('data', 'playerName', 'start_at', 'end_at', 'api_type', 'total_netAmount', 'total_betAmount', 'gameType', 'total_validBetAmount','flag'));
    }
