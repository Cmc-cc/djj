...
class Base extends Model
{
    ...
    static public $ON_LINE_HTML = [
        0      => '<strong style="color:green;">上线</strong>',
        1      => '<strong style="color:red;">下线</strong>'
    ];
   ...
   const BANK_TYPE_SEVENTEEN = 17;
    const BANK_TYPE_EIGHTEEN = 18;
    const BANK_TYPE_NINETEEN = 19;
    const BANK_TYPE_TWENTY = 20;
    const BANK_TYPE_TWENTY_ONE= 21;
    const BANK_TYPE_TWENTY_TWO = 22;
    const BANK_TYPE_TWENTY_THREE =23;
    const BANK_TYPE_TWENTY_FOUR = 24;
    const BANK_TYPE_TWENTY_FIVE =25;
    const BANK_TYPE_TWENTY_SIX = 26;
    const BANK_TYPE_TWENTY_SEVEN = 27;
    const BANK_TYPE_TWENTY_EIGHT = 28;
    const BANK_TYPE_TWENTY_NINE = 29;
    const BANK_TYPE_TWENTY_TEN = 30;
    const BANK_TYPE_THREETY_ONE = 31;
    const BANK_TYPE_THREETY_TWO = 32;
    const BANK_TYPE_THREETY_THREE = 33;
    static public $BANK_TYPE = [
        self::BANK_TYPE_ONE => '轉數快',
        // self::BANK_TYPE_TWO => '轉數快',
        self::BANK_TYPE_THREE => '匯豐銀行',
        self::BANK_TYPE_FOUR => '中國銀行',
        self::BANK_TYPE_FIVE => '恒生銀行',
        self::BANK_TYPE_SIX => '渣打銀行',
        self::BANK_TYPE_SEVEN => '工商銀行',
        self::BANK_TYPE_EIGHT => '工商銀行（亞洲-029）',
        self::BANK_TYPE_NINE => '工商銀行（亞洲-072）',
        self::BANK_TYPE_TEN => '東亞銀行',
        self::BANK_TYPE_ELEVEN => '南洋銀行',
        self::BANK_TYPE_TWELVE => '建設銀行',
        self::BANK_TYPE_THIRTEEN => '星展銀行',
        self::BANK_TYPE_FOURTEEN => '中信銀行',
        self::BANK_TYPE_FIFTEEN => '招商永隆',
        self::BANK_TYPE_SIXTEEN => '大新銀行',
        self::BANK_TYPE_SEVENTEEN => '花旗銀行',
        self::BANK_TYPE_EIGHTEEN => '交通銀行', 
        self::BANK_TYPE_NINETEEN => '上海商業',
        self::BANK_TYPE_TWENTY => '創興銀行',
        self::BANK_TYPE_TWENTY_ONE=> '集友銀行',
        self::BANK_TYPE_TWENTY_TWO => '富邦銀行',
        self::BANK_TYPE_TWENTY_THREE => '大眾銀行',
        self::BANK_TYPE_TWENTY_FOUR => '眾安銀行',
        self::BANK_TYPE_TWENTY_FIVE => '匯立銀行',
        self::BANK_TYPE_TWENTY_SIX => '平安壹賬通銀行（392）',
        self::BANK_TYPE_TWENTY_SEVEN => 'Livi銀行（388）',
        self::BANK_TYPE_TWENTY_EIGHT => 'PayMe',
        self::BANK_TYPE_TWENTY_NINE => 'TNG (Asia) Limited',
        self::BANK_TYPE_TWENTY_TEN => 'Tap and Go (拍住賞）',
        self::BANK_TYPE_THREETY_ONE => '支付寶',
        self::BANK_TYPE_THREETY_TWO => '三三金融服務有限公司',
        self::BANK_TYPE_THREETY_THREE => '天星銀行',
    ];
    //   const BANK_TYPE_ONE         = 1;
    // const BANK_TYPE_TWO         = 2;
    // const BANK_TYPE_THREE       = 3;
    ...
    // static public $BANK_TYPE = [
    //     self::BANK_TYPE_ONE => '中国工商银行',
    //     self::BANK_TYPE_TWO => '中国建设银行',
    //     self::BANK_TYPE_THREE => '中国农业银行',
    //     self::BANK_TYPE_FOUR => '中国银行',
    //     self::BANK_TYPE_FIVE => '中国交通银行',
    //     self::BANK_TYPE_SIX => '招商银行',
    //     self::BANK_TYPE_SEVEN => '广发银行',
    //     self::BANK_TYPE_EIGHT => '平安银行',
    //     self::BANK_TYPE_NINE => '浦发银行',
    //     self::BANK_TYPE_TEN => '民生银行',
    //     self::BANK_TYPE_ELEVEN => '中国邮政储蓄银行',
