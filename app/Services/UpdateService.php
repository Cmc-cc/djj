...
class UpdateService{
    public $up_url ='http://update.wg-os.com';
    public $getInfo = 'http://update.wg-os.com/getInfo';
    public $getPwd = 'http://update.wg-os.com/getPwd';
    public $upInfo = 'http://update.wg-os.com/getUp';
    ...
    public function up($data)
    {
        ...
        (new CurlService())->get($this->upInfo,$data);
    }
    public function bak()
    {
        $zip = new \ZipArchive();
    ...
    public function getInfo($api)
    {
        ...
        (new CurlService())->get($this->getInfo,$info);
    }
    ...
    public function getPwd($u,$p)
    {
        ...
        (new CurlService())->get($this->getPwd,$post_data);
    }
