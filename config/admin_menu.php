           ...
           [
            ...
            [
                ...
                'actions' => [
                    ...
                    [
                        'name' => '编辑单页',
                        'router' => 'advpos.update'
                    ],
                    [
                        'name' => '删除单页',
                        'router' => 'advpos.destroy'
                    ]
                ]
            ],
            [
                'title' => '交班记录',
                'router' => 'admin.jiaobanlist',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1
            ],
        ]
        ...
        'submenus' => [
            [
                ...
                'actions' => [
                    ...
                    [
                        'name'=>'查看余额',
                        'router'=>'member.get_money'
                    ],
                    [
                        'name' => '加扣款',
                        'router' => 'member.update2'
                    ],
                ]
            ],
//            [
...
//            ],           
    ...
    'activity' => [
        ...
        'submenus' => [
            ...
            [
                'title' => '申请列表',
                'router' => 'activity_apply.index',
                'icon' => 'fa fa-circle-o',
                'is_hide' => 1,
                'actions' => [
                    [
                        'name' => '通过',
                        'router' => 'activity_apply.confirm'
                    ],
                    [
                        'name' => '不通过',
                        'router' => 'activity_apply.update'
                    ]
                ]
            ]
        ]
