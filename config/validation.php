...
return [
    'member' => [
        'register_one' => [
            'name' => [
                'name' => '用户名',
                'rules' => 'required|min:4|max:8|unique:members',
                'message' => ['min' => '用户名最少为4位', 'max' => '用户名最多为8位','unique' => '该名称已存在']
            ],
            'password' => [
                'name' => '注册密码',
            ...
            /*'real_name' => [
                'name' => '姓名',
                'rules' => 'required|unique:members',
                'message' => ['unique' => '该姓名已存在'],
            ],
            'phone' => [
                'name' => '手机',
                'rules'=>'regex:/^1[345678][0-9]{9}$/|unique:members',
                'message' => ['regex' =>'手机号码格式不正确','unique'=>'手机号码已经存在']
            ],*/
            'qk_pwd' => [
                'name' => '取款密码',
