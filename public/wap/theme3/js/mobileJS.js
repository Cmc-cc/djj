...
function showMessageDiog(obj, type) {
    ...
    if (type == "siteEmail") {
        ...
        for (var i = 0; i < noticeSwiperLayout.length; i++) {
            ...
            str += '<li class="ng-scope ng-binding" onclick="showMessageContent(this)"><img src="/wap/theme3/images/notice.png" class="notice" /><span class=" text-hide">' + noticeSwiperLayout[i].ggcontent + '</span><img src="/wap/theme3/images/more.png" class="more" /></li>';
        }
        $("#marquee-wrapper #newsBags").html(str);
    }
}
