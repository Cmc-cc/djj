...
function platformIndexs(platform, type) {
    var sport = "", lottery = "", lotteryType = "", live = "", slot = "", chess = "", gameTitle = "", competition = "";
    for (var i = 0; i < platform.length; i++) {
        var spanClass = platform[i].ifhot == true ? "sub-hot" : "";
        var newClass = platform[i].ifnew == true ? "sub-new" : "";
        var name = getTypeCh(platform[i].plattype);
        if (platform[i].plattype == "sport") {
            sport += '<div data-v-2d10ac7a = "" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType="' + platform[i].gameType + '" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top ' + spanClass + ' ' + newClass + '"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '.png" alt="" class="" ></div><p data-v-2d10ac7a="">' + platform[i].api_title + name + '</p></div></div>';
        } else if (platform[i].plattype == "lottery") {
            lotteryType += '<div data-v-4df4ea0a="" plateform="' + platform[i].api_name + '" class="gameView-top-item swiper-slide" gameType="' + platform[i].gameType + '"  onclick="showQuickData(\'' + platform[i].api_name + '\')"><span data-v-4df4ea0a="" center="" class=""></span>' + platform[i].api_title + name + '</div>';
        } else if (platform[i].plattype == "live") {
            live += '<div data-v-2d10ac7a = "" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType="' + platform[i].gameType + '" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top ' + spanClass + ' ' + newClass + '"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '.png" alt="" class="" ></div><p data-v-2d10ac7a="">' + platform[i].api_title + name + '</p></div></div>';
        } else if (platform[i].plattype == "chess") {
            chess += '<div data-v-2d10ac7a = "" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType="' + platform[i].gameType + '" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top ' + spanClass + ' ' + newClass + '"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '.png" alt="" class=""></div><p data-v-2d10ac7a="">' + platform[i].api_title + name + '</p></div></div>';
        } else if (platform[i].plattype == "competition") {
            competition += '<div data-v-2d10ac7a = "" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType="' + platform[i].gameType + '" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top ' + spanClass + ' ' + newClass + '"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '.png" alt=""></div><p data-v-2d10ac7a="">' + platform[i].api_title + name + '</p></div></div>';
            ...
            slot += '<div data-v-2d10ac7a = "" onclick="gameOpen(\'' + platform[i].api_name + '\')" platformCode="' + platform[i].api_name + '" gameType="' + platform[i].gameType + '" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top ' + spanClass + ' ' + newClass + '"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '.png" alt="" class="" ></div><p data-v-2d10ac7a="">' + platform[i].api_title + name + '</p></div></div>';
        } else if (platform[i].plattype == "liuhecai") {
            //lottery += '<li><a href="javascript:;" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType ="' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '6.png" alt="' + platform[i].api_name + '六合彩"><span class="item-name">' + platform[i].api_title + '六合彩</span></a></li>';
        } else if (platform[i].plattype == "guanfangcai") {
            // lottery += '<li><a href="javascript:;" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType ="' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + 'gfc.png" alt="' + platform[i].api_name + '官方彩"><span class="item-name">' + platform[i].api_title + '官方彩</span></a></li>';
        }
    }
    sport += '<div data-v-2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downandroid") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/anzhuo.png" alt="" class="" ></div><p data-v-2d10ac7a="">安卓客户端</p></div></div>';
    sport += '<div data-v-2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downios") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/ios.png" alt="" class="" ></div><p data-v-2d10ac7a="">IOS客户端</p></div></div>';
    
    $("#Indexsport").html(sport);
    $("#Gametype").text("體育游戏");
   
    $("#lotteryType").html(lotteryType);
   
    //indexSwiper();
    $("#lotteryType div").first().click();
    
    live += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downandroid") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/anzhuo.png" alt="" class="" ></div><p data-v-2d10ac7a="">安卓客户端</p></div></div>';
    live += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downios") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/ios.png" alt="" class="" ></div><p data-v-2d10ac7a="">IOS客户端</p></div></div>';
   
    $("#Indexlive").html(live);
    $("#Gametype").text("真人視訊");
    
    chess += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downandroid") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/anzhuo.png" alt="" class="" ></div><p data-v-2d10ac7a="">安卓客户端</p></div></div>';
    chess += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downios") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/ios.png" alt="" class="" ></div><p data-v-2d10ac7a="">IOS客户端</p></div></div>';
   
    $("#Indexchess").html(chess);
    $("#Gametype").text("棋牌游戏");
   
    slot += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downandroid") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/anzhuo.png" alt="" class="" ></div><p data-v-2d10ac7a="">安卓客户端</p></div></div>';
    slot += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downios") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/ios.png" alt="" class="" ></div><p data-v-2d10ac7a="">IOS客户端</p></div></div>';
   
    $("#Indexslot").html(slot);
    $("#Gametype").text("電子游戏");
    
    competition += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downandroid") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/anzhuo.png" alt="" class="" ></div><p data-v-2d10ac7a="">安卓客户端</p></div></div>';
    competition += '<div data - v - 2d10ac7a = "" onclick="window.location.href=\'' + $("#userNameController").attr("downios") + '\'" relative = "" class="game-box" > <div data-v-2d10ac7a="" class="border-top"></div> <div data-v-2d10ac7a="" class="game-box-content"><div data-v-2d10ac7a="" ><img data-v-2d10ac7a="" src="/Areas/Wap7/Content/images/main/ios.png" alt="" class="" ></div><p data-v-2d10ac7a="">IOS客户端</p></div></div>';
    ...
    //GamesListShow('slot');
    $(".nav-top-box-w .scroll-item").first().click();
}
//显示隐藏首页游戏列表
...
//模板页快捷游戏菜单
function layoutPlatform(platform, clickType) {
    var sport = "", lottery = "", live = "", fish = "", slot = "", chess = "", gameTitle = "", competition = "";
    for (var i = 0; i < platform.length; i++) {
        var name = getTypeCh(platform[i].plattype);
        if (platform[i].plattype == "sport") {
            sport += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '</span></div>';
        } else if (platform[i].plattype == "competition") {
            competition += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '</span></div>';
        } else if (platform[i].plattype == "lottery") {
            lottery += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '</span></div>';
        } else if (platform[i].plattype == "fish") {
            fish += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '</span></div>';
        } else if (platform[i].plattype == "live") {
            live += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '</span></div>';
        } else if (platform[i].plattype == "chess") {
            ...
            chess += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '</span></div>';
        } else if (platform[i].plattype == "game") {
           gameTitle += '<div onclick="return landing(this);" class="menu-item"><span>' + platform[i].api_title + '</span></div>';
            slot += '<div class="menu-item" onclick="window.location.href=\'/Index/game?id=' + platform[i].api_name + '&title=' + platform[i].api_title + '\'"><span>' + platform[i].api_title + '電子</span></div>';
        } else if (platform[i].plattype == "liuhecai") {
            lottery += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '六合彩</span></div>';
        } else if (platform[i].plattype == "guanfangcai") {
            lottery += '<div class="menu-item"onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><span>' + platform[i].api_title + name + '官方彩</span></div>';
        }
    }

    if ($("#gameTitle").length > 0) {
        gameTitle += '<div class="menu-sub-group" onclick="biCommon.getApiFish()"><div class="menu-item"><span>' + platform[i].api_title + name + '</span></div></div>';
...
//显示隐藏子菜单
function openPlatform(clickType) {
    if ($("#app .menu .menu-group .menu-item[plateform=" + clickType + "]").children("svg.md-icon").attr("class").indexOf("active") != -1) {
        $("#app .menu .menu-group .menu-item[plateform=" + clickType + "]").parent().children().children("svg.md-icon").attr("class", "md-icon arrow-right md-icon-arrow-right lg");
        $("#app .menu .menu-group .menu-sub-group[plateform=" + clickType + "]").parent().children(".menu-sub-group").css("display", "none");
    }
    else {
        $("#app .menu .menu-group .menu-item[plateform=" + clickType + "]").parent().children().children("svg.md-icon").attr("class", "md-icon arrow-right md-icon-arrow-right lg");
        $("#app .menu .menu-group .menu-item[plateform=" + clickType + "]").children("svg.md-icon").attr("class", "md-icon arrow-right md-icon-arrow-right lg active");
        $("#app .menu .menu-group .menu-sub-group[plateform=" + clickType + "]").parent().children(".menu-sub-group").css("display", "none");

        $("#app .menu .menu-group .menu-sub-group[plateform=" + clickType + "]").removeAttr("style");
...
function showQuickData(type) {
    ...
    for (var i = 0; i < arr.length; i++) {
        str += '<div data-v-4df4ea0a="" class="game-box" platformCode= "' + arr[i].plateform + '" gameType= "' + arr[i].gameType + '" gameId= "' + arr[i].gameId + '" onclick= "return landing(this);"><div data-v-4df4ea0a="" class="border-top"></div><div data-v-4df4ea0a="" class="game-box-content"><img data-v-4df4ea0a="" src="/Areas/Wap7/Content/images/lottery/' + arr[i].plateform + '/' + arr[i].imgName + '.png" alt="" class="" > <p data-v-4df4ea0a="">' + arr[i].name + '</p></div> </div>';
    }
    str += '<div data-v-4df4ea0a="" class="game-box" onclick="window.location.href=\'' + $("#userNameController").attr("downandroid") + '\'"><div data-v-4df4ea0a="" class="border-top"></div><div data-v-4df4ea0a="" class="game-box-content"><img data-v-4df4ea0a="" src="/Areas/Wap7/Content/images/main/anzhuo.png" alt="" class="" > <p data-v-4df4ea0a="">安卓客户端</p></div> </div>';
    str += '<div data-v-4df4ea0a="" class="game-box" onclick="window.location.href=\'' + $("#userNameController").attr("downios") + '\'"><div data-v-4df4ea0a="" class="border-top"></div><div data-v-4df4ea0a="" class="game-box-content"><img data-v-4df4ea0a="" src="/Areas/Wap7/Content/images/main/ios.png" alt="" class="" > <p data-v-4df4ea0a="">IOS客户端</p></div> </div>';
    $("#lotterList").html(str);
    indexSwiper();
}
...
function quickNav(platform) {
    for (var i = 0; i < platform.length; i++) {
        ...
        switch (platform[i].plattype) {
            case "live":
                liveQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "game":
                slotQuick += '<li><a href="/Index/game?id=' + platform[i].api_name + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "sport":
                sportQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "lottery":
                lotteryQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "liuhecai":
                lotteryQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '6.png" /><span>' + platform[i].api_title + '六合彩</span></a></li>';
                break;
            case "guanfangcai":
                lotteryQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + 'gfc.png" /><span>' + platform[i].api_title + '官方彩</span></a></li>';
                break;
            case "chess":
                chessQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "competition":
                competitionQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            //default: slotQuick += '<li><a href="/Index/game?id=' + platform[i].api_name + '"><img src="/Areas/Wap7/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
        }
    }
}
//首页轮播
...
function swiperLoad() {
    if (indexQuickNav == 0) {
        ...
        $("#quickList").hide();
        $("#gamelist").show();
        mySwiper = new Swiper('.md-swiper-container', {
            autoplay:true
            //loop: true,
            //autoplay: 3000,
...
function login() {
    ...
    $(".mod-forms-2 input").each(function (x, y) {
        if ($(y).val().trim() == "" && !$(y).is(':hidden')) {
            notify("请输入" + $(y).attr("placeholder") + "!",2);
            boo = false
            return false;
        }
    })
...
function transactionChange(obj, num) {
    $("#num").val(1);
    $(".mine-table .historytab").hide();
    $(".mine-table .historytab").each(function (x, y) {
        if ($(y).attr("dataSource") == $("#transactionSel option:selected").attr("dataSource")) {
            $(y).show();
            return false;
        }
    })
    biCommon.mconvertrecord($("#transactionSel option:selected").attr("type"), $("#startTime").val(), $("#endTime").val(), 1);
}
function getMeg(obj) {
    ...
    var type = $("#transactionSel option:selected").attr("type");
    var page = "";
    if (obj == "-1") {
    ...
    else biCommon.getBetInfo($("#transactionSel option:selected").val(), $("#startTime").val(), $("#endTime").val(), page);
}
...
function getDataActivity(retData) {
    ...
    if (retData != "") {
        ...
        for (var i = 0; i < retData.length; i++) {
            ...
            str += '<span data-v-30793220="" onclick="changeActive(' + retData[i].Type + ',this)" class="">' + retData[i].TypeName + '</span>';

        }
        $("#activityTitle").html(str);
        $("#activityTitle span").eq(0).click();
    } else {
        notify("暂无优惠活动！");
    }
}
...
function changeActive(type, obj) {
    var str = "";
    $("#activityTitle span").removeClass("active");
    $(obj).addClass("active");
...
function getPlatform(platform) {//获取游戏列表
    ...
    for (var i = 0; i < platform.length; i++) {
        str += '<option value="' + platform[i].api_name + '">' + platform[i].api_mainname + '</option>';
        arr += '<div data-v-4a8f0578="" platform="' + platform[i].api_name + '" class="limit-item ml3"><span class="van-button__text" ><span data-v-4a8f0578="" class="button-text" >' + platform[i].api_mainname + '</span><span data-v-4a8f0578="" class="button-value yue">0</span><span data-v-4a8f0578="" class="button-value"><img src="/Areas/Wap7/Content/images/main/refresh.png" onclick="chaxun(\'' + platform[i].api_name + '\',this)"></span></span><span class="van-button__button"><i onclick="yijianinout(\'' + platform[i].api_name + '\',this,\'in\')" class="in-quot">一键转入</i><i onclick="yijianinout(\'' + platform[i].api_name + '\',this,\'out\')" class="out-quot">一键转出</i></span></div >';
...
function findPlateform(platform, type) {//刷新单个平台余额
    $("#limitlist div").each(function (x, y) {
        if (type == 1) {
            if ($(y).attr("platform") == platform) {
                $(y).find("img").click();
            }
        } else {
            platform[$(y).attr("platform")] == "-1" ? "0.00" : $(y).find("span.button-value.yue").html(platform[$(y).attr("platform")]);
        }
    })
}
            ...
            if (retData != null) {
                for (var i = 0; i < retData.length; i++) {
                    if (retData[i].type == "zfb") {
                        //str += '<option value="' + retData[i].id + '" payname ="' + retData[i].payname + '" img="' + retData[i].img + '">' + retData[i].payname + '</option>';
                        str += '<div class="col col-name tdName">' + retData[i].payname + '</div><div class="col col-data" ><label class="pay-label"><span class="blink">' + $("#userNameController").attr("minmoney") + '-' + $("#userNameController").attr("maxmoney") + '</span><input type="radio" name="payType" value="' + retData[i].payname + '"><img width="266" height="70" src="/Areas/Wap7/Content/images/main/zfbxx.png"></label></div>';
                    }
                }
                $("#skAccount").html(str);
                $("#skAccount input[type=radio]").first().prop("checked", true);
            ...
            if (retData != null) {
                for (var i = 0; i < retData.length; i++) {
                    if (retData[i].type == "qqpay") {
                        //str += '<option value="' + retData[i].id + '" payname ="' + retData[i].payname + '" img="' + retData[i].img + '">' + retData[i].payname + '</option>';
                        str += '<div class="col col-name tdName">' + retData[i].payname + '</div><div class="col col-data" ><label class="pay-label"><span class="blink">' + $("#userNameController").attr("minmoney") + '-' + $("#userNameController").attr("maxmoney") + '</span><input type="radio" name="payType" value="' + retData[i].payname + '"><img width="266" height="70" src="/Areas/Wap7/Content/images/main/qqxx.png"></label></div>';
                    }
                }
                $("#skAccount").html(str);
                $("#skAccount input[type=radio]").first().prop("checked", true);
            ...
            if (retData != null) {
                for (var i = 0; i < retData.length; i++) {
                    if (retData[i].type == "ysf") {
                        //str += '<option value="' + retData[i].id + '" payname ="' + retData[i].payname + '" img="' + retData[i].img + '">' + retData[i].payname + '</option>';
                        str += '<div class="col col-name tdName">' + retData[i].payname + '</div><div class="col col-data" ><label class="pay-label"><span class="blink">' + $("#userNameController").attr("minmoney") + '-' + $("#userNameController").attr("maxmoney") + '</span><input type="radio" name="payType" value="' + retData[i].payname + '"><img width="266" height="70" src="/Areas/Wap7/Content/images/main/ysfxx.png"></label></div>';
                    }
...
function compaly(num) {
    ...
    //    }
    //} else {
    //    notify("存款金额须在" + $("#userNameController").attr("minmoney") + "~" + $("#userNameController").attr("maxmoney") + "之间",2);
    //    return false;
    //}
    if ($("#commoney" + num).val() != "" && parseFloat($("#commoney" + num).val().trim()) >= $("#userNameController").attr("minmoney") && parseFloat($("#commoney" + num).val().trim()) <= $("#userNameController").attr("maxmoney")) {
        if (num != 0) {
...
function backPre() {
    window.location.href = "/Wap7/Index/info";
}
//withdraw提款页面
function tikuan(obj) {
...
function notify(msg, type) {//1:没图标 2：有图标，错误提示
    ...
    if (type == 1) {
        $("#app div.md-toast.center").first().css("display", "block");
        $("#app div.md-toast.center").first().find("span").text(msg);
    } else {
        $("#app div.md-toast.center.has-icon").css("display", "block");
        $("#app div.md-toast.center.has-icon").find("span").text(msg);
    }
    //if (!type) {
    //    type = 'info';
    //}
...
function closeNotify(type) {
    setTimeout(function () {
        if (type == 1) {
            $("#app div.md-toast.center").first().css("display", "none");
            $("#app div.md-toast.center").first().find("span").text("");
        } else {
            $("#app div.md-toast.center.has-icon").css("display", "none");
            $("#app div.md-toast.center.has-icon").find("span").text("");
        }
    }, 1500)
}
//获取对应的電子列表
function getElectronic(type) {
    var title = biCommon.getQueryString()["title"];
    $("div.title h3.title").text(title);
...
function landing(obj) {
    if ($("#userNameController").val() != "") {
        ...
        if ($(obj).attr("platformCode") == "IG" || $(obj).attr("plateform") == "IGA") {
            var IGGameType = $("#lotteryType div[plateform='" + platformCode + "']").attr("gametype");
            IGGameType = IGGameType.replace("gfc&gameId=10000&", "");
            IGGameType = IGGameType.replace("GFC&gameId=10000&", "");
            IGGameType = IGGameType.replace("s&gameId=10000&", "");
            IGGameType = IGGameType.replace("S&gameId=10000&", "");
            gameType += IGGameType;
        }
...
function addHb() {
    ...
    num++;
    $(".couten").append("<li class='li" + num + "' ><a href='javascript:;'><img src='/Areas/Wap7/Content/images/main/hb_" + hb + ".png'></a></li>");
    $(".li" + num).css({
        "left": Left,
    });
    $(".li" + num + " a img").css({
