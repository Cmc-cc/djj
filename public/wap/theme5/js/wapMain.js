...
function platformIndexs(platform) {
    ...
    for (var i = 0; i < platform.length; i++) {
        if (platform[i].plattype != "fish") {
            ...
            if (platform[i].plattype == "game") {
                str += '<li><a href="/Index/game?id=' + platform[i].api_name + '"><img src="/Areas/Wap2/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '.png"/><span>' + platform[i].api_title + name + '</span></a></li>';
            } else {
                if (platform[i].plattype == "liuhecai") {
                    str += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '6.png"/><span>' + platform[i].api_title + '六合彩</span></a></li>';
                } else if (platform[i].plattype == "guanfangcai"){
                    str += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + 'gfc.png"/><span>' + platform[i].api_title + '官方彩</span></a></li>';
                } else {
                    str += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimg/' + platform[i].api_name.toUpperCase() + '.png"/><span>' + platform[i].api_title + name + '</span></a></li>';
                }
            }
            count++;
        }
    ...
    if ($("#userNameController").attr("downandroid") != "") {
        count++;
        var android = '<li><a href="' + $("#userNameController").attr("downandroid") + '"><img src="/Areas/Wap2/Content/images/main/anzhuo.png"/><span>安卓客户端</span></a></li>';
        str += android;
        $("#quickList").append(android);
    }
    if ($("#userNameController").attr("downios") != "") {
        count++;
        var ios = '<li><a href="' + $("#userNameController").attr("downios") + '"><img src="/Areas/Wap2/Content/images/main/ios.png"/><span>IOS客户端</span></a></li>';
        str += ios;
        $("#quickList").append(ios);
    }
    if (count % 4 != 0) {
...
function quickNav(platform) {
    for (var i = 0; i < platform.length; i++) {
        ...
        switch (platform[i].plattype) {
            case "live":
                liveQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "game":
                slotQuick += '<li><a href="/Index/game?id=' + platform[i].api_name + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "sport":
                sportQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "lottery":
                lotteryQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "liuhecai":
                lotteryQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '6.png" /><span>' + platform[i].api_title + '六合彩</span></a></li>';
                break;
            case "guanfangcai":
                lotteryQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + 'gfc.png" /><span>' + platform[i].api_title+ '官方彩</span></a></li>';
                break;
            case "chess":
                chessQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            case "competition":
                competitionQuick += '<li><a href="javascript:void(0)" onclick="return landing(this);" platformCode="' + platform[i].api_name + '" gameType = "' + platform[i].gameType + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
                break;
            //default: slotQuick += '<li><a href="/Index/game?id=' + platform[i].api_name + '"><img src="/Areas/Wap2/Content/images/BIimgQuick/' + platform[i].api_name.toUpperCase() + '.png" /><span>' + platform[i].api_title + name + '</span></a></li>';
        }
    }
}
...
function getPlatform(platform) {//获取游戏列表
    ...
    for (var i = 0; i < platform.length; i++) {
        ...
        arr += "<tr platform='" + platform[i].api_name + "'><td><span>" + platform[i].api_mainname + "</span><b>0.00</b><img src='/Areas/Wap2/Content/images/main/freshmoney.svg' onclick='chaxun(\"" + platform[i].api_name + "\",this)'/><div class='btntwo'><button onclick='yijianinout(\"" + platform[i].api_name + "\",this,\"in\")'>一键转入</button><button onclick='yijianinout(\"" + platform[i].api_name + "\",this,\"out\")'>一键转出</button></div></td></tr>";
    }
    $("#limitplace").html(str);
    $("#limitlist").html(arr);
}
...
function addHb() {
    ...
    num++;
    $(".couten").append("<li class='li" + num + "' ><a href='javascript:;'><img src='/Areas/Wap2/Content/images/main/hb_" + hb + ".png'></a></li>");
    $(".li" + num).css({
        "left": Left,
    });
    $(".li" + num + " a img").css({
