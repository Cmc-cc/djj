// JavaScript Document   //cookie util
    ...
    function openChat(chaturl,kuan,gao){
        // window.open(chaturl,"","toolbar=0,scrollbars=0,location=0,menubar=0,resizable=1,width="+kuan+",height="+gao+"");
    // try{
    //     var url=chaturl;
    ...
    //     window.open(url,"","toolbar=0,scrollbars=0,location=0,menubar=0,resizable=1,width="+kuan+",height="+gao+"");
