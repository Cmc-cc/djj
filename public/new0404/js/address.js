(function(){
    ...
    var app = {
        ...
        bindEvents: function(){
            app.$province.bind('change', app.getCity);
        },
        getProvince: function(){
            var tag = "<option value=''>请选择</option>";
            for(var key in province)
            {
                var value = province[key];
                tag += "<option value='" + value + "'>" + value + "</option>";
            }
            app.$province.html(tag);
        },
        getCity: function(){
            var $this = $(this);
            var index = parseInt($this.find('option:selected').index()) - 1;
            var thisCity = city[index];
            var tag = "<option value=''></option>";
            for(var key in thisCity)
            {
                var value = thisCity[key];
                tag += "<option value='" + value + "'>" + value + "</option>";
            }
            app.$city.html(tag);
        },
