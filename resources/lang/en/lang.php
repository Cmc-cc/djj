...
return [
    ...
    'fh'=>'return',
     ...
     'neirong'=>'content',
     'zhanghao'=>'account',
     'xzyhk'=>'Add a new bank card',
     'yhksm'=>'Bank card or transfer fast account, each can only be bound to one group, and must be the same name',
    'thzh'=>'Bank account number',
    'bind'=>'Binding',
    'qsrusdkzh'=>'Please enter a USDT account',
    'usdkzh'=>'USDT account',
    'sktdsy'=>'Please use ERC20 for payment channel',
...
'shengyujihe'=>'Remaining amount',
    ...
    'huiyuantequan' => 'Membership privileges',
    'dangqiandengji' => 'current level',
    'lijinbiao' => 'Gift watch',
    'woyaochongzhi' => 'I need to recharge',
    'lijinjilu' => 'Gift Record',
    'liji_title1' => 'Upgrade to receive lottery money, and distribute gift money on Monday/1st of each month',
    'jinjicaijin' => 'Advance to the lottery',
    'lingqulijin' => 'Collect gift money',
    'zhoulijin' => 'Zhou Lijin',
    'benzhoulijin' => "This week's gift money",
    'yilingqu' => 'Received',
    'weilingqu' => 'Unclaimed',
    'yuelijin' => 'Monthly gift money',
    'benyuelijin' => "This month's gift money",
    'guizeshuoming' => 'Rule Description',
    'guizeshuoming_1' => '1. VIP level upgrade, eligible to receive promotion lottery once per level;',
    'guizeshuoming_2' => '2. Weekly and monthly gift payments are based on the VIP level of the last day of last week and the end of the previous month, and can be collected after the 1st of each week and month;',
    'guizeshuoming_3' => '3. The weekly and monthly gift money must meet the VIP level requirements for the corresponding weekly and monthly code washing amount, and can be collected after at least one recharge this week and month;',
    'lingqushijian' => 'Collection time',
    'lingqujine' => 'Claim amount',
    'VIPdengji' => 'VIP level',
    'benzhouyiling' => 'Received this week',
    'vipzhongxin' => 'VIP Center',
    'ninxuyaowei' => 'You need to',
    'zhuanrujinema' => 'Is the amount transferred in',
    'dangqianyue' => 'Current balance',
    'zhijiezhuanruyouxi' => 'Directly enter the game',
    'lijizhuanruyouxi' => 'Immediately switch to the game',
    'sousuoyouxi' => 'Search game',
    'gerenshezhi' => 'Personal settings',
    'pingtaigonggao' => 'Platform announcement'
];
