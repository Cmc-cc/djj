...
.noticeAltbox-bottom{ display:flex; justify-content:center; flex-wrap:wrap; padding:10px 0;}
    ...
    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
              ...
              <div class="swiper-slide swiper-slide-active">                
					<div class="box">
						...
						<div class="cardBottom">
								<a class="toplay2" @if($_member) data-url="/game/playGame?plat_type=JK&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="JK"><img src="/JOKER.png"></a>
								
								<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=JD&game_type=SL&game_code=&devices=1" @else data-url="" @endif data-code="JD"><img src="/JDB.png"></a>
								
								<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=PG&game_type=SL&game_code=&devices=1" @else data-url="" @endif data-code="PG"><img src="/PG.png"></a>
								
								<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=CQ&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="CQ"><img src="/LIVE22.png"></a>
								
								<!--<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=PS&game_type=&game_code=&devices=1" @else data-url="" @endif data-code="PS"><img src="/yg.png"></a>-->
								
								<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=PN&game_type=3&game_code=&devices=1" @else data-url="" @endif data-code="PN"><img src="/png.png"></a>
								
								<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=GB&game_type=SL&game_code=&devices=1" @else data-url="" @endif data-code="GB"><img src="/bbindz.jpg"></a>
						</div>
					</div>
               </div>
            </div>
     ...
     <!--         <div class="swiper-slide swiper-slide-active">                -->
					...
					<!--			<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=DG&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="DG"><img src="/DG.png"></a>-->
					<!--			<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=S6&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="S6"><img src="/sexy.jpg"></a>-->
															
					<!--			<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=WC&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="WC"><img src="/WM.png"></a>-->
															
					<!--			<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=GB&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="GB"><img src="/bbin.jpg"></a>-->
					<!--			<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=E0&game_type=1&game_code=&devices=1" @else data-url="" @endif data-code="E0"><img src="/evosx.png"></a>-->
              ...
              <div class="swiper-slide swiper-slide-active">                
				  	<div class="box">
						...
						<div class="cardBottom">
								...
								<!--<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=KY&game_type=&game_code=CB&devices=1" @else data-url="" @endif data-code="KY"><img src="/KY.png"></a>-->
								<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=NP&game_type=&game_code=CB&devices=1" @else data-url="" @endif data-code="NP"><img src="/KY.png"></a>
              ...
              <div class="swiper-slide swiper-slide-active">                
					<div class="box">
						...
						<div class="cardBottom">
								...
								<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=JK&game_type=FH&devices=1" @else data-url="" @endif data-code="JK"><img src="/JOKER.png"></a>
								<!--<a class="toplay" @if($_member) data-url="/game/playGame?plat_type=JD&game_type=FH&devices=1" @else data-url="" @endif  data-code="GB"><img src="/JDB.png"></a>-->
