       ...
       <!--         </select>-->
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		<p class="row account">
                    <span class="asain"> {{trans("lang.skzh")}}：</span>
        			<span class="chatNumber2" style="color:#fb2464 ;">{{ $_system_config->qq_account }}</span>
        		...
        		<p class="row banker">
        			<span class="asain">{{trans("lang.skzh")}}：</span>
        			<span class="chatNumber3" style="color:#fb2464 ;">{{ $_system_config->qq_nickname }}</span>
        	...
        	<p style="color: #000;line-height: 3;margin-top: 20px;">
