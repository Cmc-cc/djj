...
<style>
    ...
    <div class="m_container huodong_box">

		<div class="nytop">
			<a href="javascript:history.go(-1);" class="fhbtn"></a>
			<h1>{{trans("lang.hdxq")}}</h1>
    		...
    		<div class="zzc">
        		...
        		<div class="qbhd_nr">
        			<ul>
        					<li>
        						<div class="qbhdbox qbhdboxs" style="height:auto;background: #fff">
        							<h3><?php echo stripslashes($data->title_content); ?></h3>
