	...
	<div class="grzx">
		<div class="grzxbox">
			...
			<ul>
				...
				<!--<li style="float: left;"  onclick="location.href='{{$AGENT_URL}}/daili/login2?token={{$_member->last_session}}'">-->
				<!--    <span style="line-height:1.5">-->
	...
	<div class="zzc">
		...
		<div class="zzc_nr">
			...
			<p>
				...
				<span id="gamemoney" class="member_money" style="color: #eb8f74;font-size: .48rem;display:block;float:left;width:52%;line-height: .48rem;">{{ $_member -> money }}</span>
			...
			<ul>
				 ...
				 @else
				    <li style="width:50%;"><a href="/m/recharge" class="on1"><i class="xtb6"></i>{{trans("lang.chongzhi")}}</a></li>
				  	<li style="width:50%"><a href="/m/drawing"><i class="xtb8"></i>{{trans("lang.tixian")}}</a></li>
				 @endif
		...
		<div class="qbhd_nr">
			<ul>
					<li>
						<div class="qbhdbox">
						    @if($msg)
						        <h3 style="line-height: 1.2;">{{$msg->content}}</h3>
							@else
						        <h3>暫無記錄</h3>
						    @endif
