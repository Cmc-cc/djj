											...
											for(let item of data2){
												...
												$('#list').append(`<div class="list" onclick="qiehuan(this)">
														<div class="list-top">
															...
															<div class="list-top2">
																<div>{{trans("lang.touzhu")}}: <strong style="color:red;">$ `+item.betAmount+`</strong></div>
																<div>{{trans("lang.zjj")}}：
														...
														<div class="list-bottom">
															<div><span>{{trans("lang.dingdanhao")}}</span><span>`+ item.billNo+`</span></div>
															<div><span>{{trans("lang.jiaoyishijian")}}</span><span>` + item.betTime +`</span></div>
										
															<div><span>{{trans("lang.touzhu")}}</span><span>`+item.betAmount+`</span></div>
															<div><span>{{trans("lang.zjj")}}</span><span>` + item.netAmount +`</span></div>
														</div>
													</div>`)
											}
