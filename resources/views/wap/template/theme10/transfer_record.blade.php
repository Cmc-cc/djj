...
<div class="m_container">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		...
		<a href="/m/transfer_record"><div class="acse as">额度转换</div></a>
	</div>
    ...
    <div class="m_body" style="margin-top:2.42rem">
		<div class="container-fluid gm_main">			
			<div class="content">
				<div class="info-list" style="padding-bottom:10px;">
...
let type = 1;
				function qiehua(int,_this){
					...
					getUserList.get();
					$("#load").text('{{trans("lang.shanglajiazaigengduo")}}');
					...
					$(window).scrollTop(0)
						...
						var getUserList={
							...
							get:function () {
								...
								$.ajax({
									url : " /m/transfer_record_api?page="+getUserList.page+'&day='+type,
									type : 'GET',
										...
										if(data.status.errorCode == 0){
											...
											for(let item of data2){
												...
												$('#list').append(`<div class="list">
														<div class="list-top" style="background:transparent;">
															<div class="list-top1">
																<h5 style="color:red;">`+item.money+`</h5>
																<p>`+item.created_at+`</p>
															</div>
															<div class="list-top2">
																<div>{{trans("lang.shuruzhanghu")}}: `+item.transfer_in_account+`</div>
																<div>{{trans("lang.shuchuzhanghu")}}：
