...
<div class="m_container">
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		...
		<a href="/m/member_offline_drawing"><div class="acse as">{{trans('lang.xxhytkjl')}}</div></a>
					...
					$(window).scrollTop(0)
						...
						var getUserList={
							...
							get:function () {
								...
								$.ajax({
									url : "/m/member_offline_drawing_api?page="+getUserList.page+'&day='+type,
									type : 'GET',
											...
											for(let item of data2){
												...
												$('#list').append(`<div class="list">
														...
														<div class="list-bottom">
															...
															<div><span>{{trans("lang.jiaoyifangshi")}}</span><span>`+item.name+`</span></div>
