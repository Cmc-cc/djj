...
<div class="nytop">
    ...
    <h1>{{trans("lang.zfbsm")}}</h1>
	<h2><a class="kefu_box">{{trans("lang.zxkf")}}</a></h2>
</div>
	...
	<div class="drawInfor">
		<ul id="step1">
            ...
            <li class="bankChose">
				...
				<div class="bankBox">
													<b class="on">
						<img src="/mobile/img/2-alipay.0691d59869edc30815f0.svg">{{trans("lang.zfbsm")}}
		...
		<div class="bq2-wrapper" style="display:none;">
        	...
        	<div class="bot-container">
        		<p class="row account">
        			...
        			<img src="{{ $setting->alipay_qrcode }}"  style="width:200px;height:200px;margin:0 auto;"/>
        	...
        	<p style="color: #ffff00;line-height: 3;margin-top: 20px;">
