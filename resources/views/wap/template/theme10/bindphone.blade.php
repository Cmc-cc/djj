...
<body class="m_bac">
	...
	<div class="drawInfor">
		<ul>
			@if($member->phone)
			    <li class="usdt"><span> {{trans("lang.ybdsjh")}}&nbsp;&nbsp;&nbsp;{{$member->phone}}</span></li>
			@endif
			<!--<li>-->
			<!--    <span>区号</span>-->
			<!--	<select class="select" name="bank_name" style="color: rgb(153, 153, 153);" id="bank_name">-->
			<!--		<option value="" style="color: rgb(255, 255, 255);">-- {{trans("lang.qxz")}} --</option>-->
			<!--								<option value="转速快">{{trans("lang.zsk")}}</option>-->
   <!--                                         <option value="USDT">USDT</option>-->
   <!--                                         <option value="中国工商银行">{{trans("lang.zggsyh")}}</option>-->
   <!--                                         <option value="中国建设银行">{{trans("lang.zgjsyh")}}</option>-->
   <!--                                         <option value="中国农业银行">{{trans("lang.zgnyyh")}}</option>-->
   <!--                                         <option value="中国银行">{{trans("lang.zgyh")}}</option>-->
   <!--                                         <option value="中国交通银行">{{trans("lang.zgjtyh")}}</option>-->
   <!--                                         <option value="招商银行">{{trans("lang.zsyh")}}</option>-->
   <!--                                         <option value="广发银行">{{trans("lang.gfyh")}}</option>-->
   <!--                                         <option value="平安银行">{{trans("lang.payh")}}</option>-->
   <!--                                         <option value="浦发银行">{{trans("lang.pfyh")}}</option>-->
   <!--                                         <option value="民生银行">{{trans("lang.msyh")}}</option>-->
   <!--                                         <option value="中国邮政储蓄银行">{{trans("lang.zgyz")}}</option>-->
   <!--                                         <option value="华夏银行">{{trans("lang.hxyh")}}</option>-->
   <!--                                         <option value="深圳发展银行">{{trans("lang.szfz")}}</option>-->
   <!--                                         <option value="中信银行">{{trans("lang.zxyh")}}</option>-->
   <!--                                         <option value="兴业银行">{{trans("lang.xyyh")}}</option>-->
   <!--                                         <option value="光大银行">{{trans("lang.gdyh")}}</option>-->
   <!--                                         <option value="渣打银行">{{trans("lang.zdyh")}}</option>-->
   <!--                                         <option value="汇丰银行">{{trans("lang.hfyh")}}</option>-->
   <!--                                         <option value="中兴银行">{{trans("lang.zxyh")}}</option>-->
   <!--                                         <option value="恒生银行">{{trans("lang.hsyh")}}</option>-->
   <!--                                         <option value="创新银行">{{trans("lang.cxyh")}}</option>-->
			<!--						</select>-->
			<!--</li>-->
			<li><span>{{trans("lang.sjh")}}</span><input type="text" name="phone" id="phone" placeholder="{{trans('lang.qsr')}}{{trans('lang.sjh')}}" autocomplete="off"></li>
			
			<li style="position:relative;">
			    <span>{{trans("lang.yzm")}}</span>
			    <input type="number" name="code" id="code" autocomplete="off" placeholder="{{trans('lang.qsr')}}{{trans('lang.yzm')}}">
