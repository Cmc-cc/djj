...
<link href="/web/layui/css/layui.css" type="text/css" >
</head>
<style>
...
<div class="m_container">
	...
	<div class="nytop" style="position: fixed;top:0;width: 100%;">
		...
		<h2><a href="/m" style="left: .3rem;">首頁</a></h2>
		<h1>{{trans("lang.hysybb")}}</h1>
	</div>
	...
	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		...
		<a href="/m/member_offline_recharge"><div class="acse ">{{trans('lang.xxhyckjl')}}</div></a>
		...
		<a href="/m/member_offline_sy"><div class="acse as">{{trans('lang.hysybb')}}</div></a>
	</div>
	...
	<div class="select-info">
        ...
        <div class="select-time" style="width:72%;margin-left: 0px;">
			<div style="width:100%;overflow: hidden;display: flex;height: 33px;">
    <!--            <p  style="width: 16%" tid="1" @if($day==1)class="on"@endif onclick="location.href='/m/member_offline_sy?day=1'">今日</p>-->
    <!--            <p style="width: 15.5%" tid="2" @if($day==2)class="on"@endif onclick="location.href='/m/member_offline_sy?day=2'">2日</p>-->
				<!--<p style="width: 15.5%" tid="3" @if($day==3)class="on"@endif onclick="location.href='/m/member_offline_sy?day=3'">3日</p>-->
				<!--<p style="width: 15.5%" tid="5" @if($day==5)class="on"@endif onclick="location.href='/m/member_offline_sy?day=5'">5日</p>-->
    <!--            <p style="width: 18%" tid="7" @if($day==7)class="on"@endif onclick="location.href='/m/member_offline_sy?day=7'">7日内</p>-->
    <!--            <p style="width: 19.5%" tid="30" @if($day==30)class="on"@endif onclick="location.href='/m/member_offline_sy?day=30'">30日内</p>-->
                <input type="text" class="layui-input " id="start" placeholder="开始时间" style="color: #fff;" value="{{$cn_begin}}">
                <input type="text" class="layui-input " id="end" placeholder="结束时间" style="color: #fff;" value="{{$cn_end}}">
            </div>
        </div>
    </div>
		...
		<div class="container-fluid gm_main">			
			<div class="content">
				<div class="info-list">
    			    ...
    			    <table class="Hyzx-table mt10 MMain" style="line-height: 1.5;width:100%;margin-top:20px;  font-size: 14px;">
                        
                        <tbody id="general-msg">
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.ckzs')}}</td>
                                <td style="text-align:center;">{{ $total_recharge}}</td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.ckbs')}}</td>
                                <td style="text-align:center;">{{ $recharge_count}}</td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.tkze')}}</td>
                                <td style="text-align:center;">{{ $total_drawing}}</td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.tkbs')}}</td>
                                <td style="text-align:center;">{{ $drawing_count}}</td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.hlze')}}</td>
                                <td style="text-align:center;">{{ $total_dividend}}</td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.hlbs')}}</td>
                                <td style="text-align:center;">{{ $dividend_count}}</td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.yl')}}</td>
                                <td style="text-align:center;">{{ round($total_recharge - $total_drawing,2) }}</td>
                            </tr>   
                            <tr class="haveRead MColor1" style="display: table-row;">
                                <td style="text-align:center;">{{trans('lang.hysy')}}</td>
                                <td style="text-align:center;">{{ round($total_drawing -  $total_recharge,2) }}</td>
                            </tr>   
                        </tbody>
...
layui.use('laydate', function(){
    ...
    laydate.render({
        ...
        ,done: function(value, date){
            // console.log($('#start').val(),value)
            location.href='/m/member_offline_sy?cn_begin='+$('#start').val()+'&cn_end='+value;
        }
    });
})
