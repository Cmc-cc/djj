...
<div class="m_container">
	...
	<div class="nytop" style="position: fixed;top:0;width: 100%;">
		...
		<h1>{{trans("lang.yjffjl")}}</h1>
	</div>

	<div style="position: fixed;top:.9rem;width: 100%;height:.68rem;background: #3a3a3a;">
		<a href="/m/daili_money_log"><div class="acse as">{{trans('lang.yjffjl')}}</div></a>
					...
					$(window).scrollTop(0)
						...
						var getUserList={
							...
							get:function () {
								...
								$.ajax({
									url : "/m/daili_money_log_api?page="+getUserList.page+'&day='+type,
									type : 'GET',
										...
										if(data.status.errorCode == 0){
											...
											for(let item of data2){
												...
												$('#list').append(`<div class="list">
														<div class="list-top" style="background-size:0;">
															<div class="list-top1">
																<h5>{{trans('lang.yjffjl')}}</h5>
																<p>`+item.created_at+`</p>
															</div>
															<div class="list-top2">
														...
														<div class="list-bottom">
															<div><span>{{trans("lang.jine")}}</span><span>`+ item.money+`</span></div>
															<div><span>{{trans("lang.shijian")}}</span><span>` + item.created_at +`</span></div>
