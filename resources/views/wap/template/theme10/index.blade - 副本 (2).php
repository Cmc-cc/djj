<!DOCTYPE html>
<!-- saved from url=(0025)https://www.cash669.net/m -->
...
<div class="header">
    	<div class="headerTop">
            ...
            @if (!Auth::guard('member')->guest())
                <a href="/m/transfer" class="signBtn">{{trans("lang.tixian")}}</a>
     ...
     <!-- <div class="userChose">
        <img src="/new/css/e37c1ed3c4fa52f7f906ea1b09a1a3cc2e4a25be.png">
     </div> -->
</div>	<div class="banner">
		<div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-ios">
			<div class="swiper-wrapper" style="transform: translate3d(-1128px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="6" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/986b36c7e051625b5dc8e843dabd868080ccb992.jpg"></a></div>
			<div class="swiper-slide" data-swiper-slide-index="0" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/d199d79392cb6e5c71c0d92f99a7f107882c8e3b.jpg"></a></div>
			<div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="1" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/4f9d541593d82b5431e7a0d188b5807d248dc7af.jpg"></a></div>
			<div class="swiper-slide swiper-slide-active" data-swiper-slide-index="2" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/e24bc55370370c6a483103dd1c0b618ee5d8acf8.jpg"></a></div>
			<div class="swiper-slide swiper-slide-next" data-swiper-slide-index="3" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/b24a118c3bbfefd4d355b14442b8a01103d0dfe1.jpg"></a></div>
			<div class="swiper-slide" data-swiper-slide-index="4" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/f413476f35fa608dce7ee91d8a4e999598b78179.jpg"></a></div>
			<div class="swiper-slide" data-swiper-slide-index="5" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/34ae1d781711c65343a15e774e81dc43b40916a7.jpg"></a></div>
			<div class="swiper-slide" data-swiper-slide-index="6" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/986b36c7e051625b5dc8e843dabd868080ccb992.jpg"></a></div>
			<div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" style="width: 376px;"><a href="https://www.cash669.net/m"><img src="/new/css/d199d79392cb6e5c71c0d92f99a7f107882c8e3b.jpg"></a></div></div>
	...
	<div class="gameSlide">
		<div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-autoheight swiper-container-ios">
			<div class="swiper-wrapper" style="height: 937px; transform: translate3d(0px, 0px, 0px);">
				...
				<div class="swiper-slide" style="width: 376px;">
									<!-- <a href=""><img src="/wap/images/ibc.jpg"></a> -->
											<a href="javascript:;" onclick="window.open(&#39;https://www.cash669.net/m/login&#39;,&#39;_self&#39;)"><img src="/new/css/obty.png"></a>
																<a href="javascript:;" onclick="window.open(&#39;https://www.cash669.net/m/login&#39;,&#39;_self&#39;)"><img src="/new/css/bbinty.jpg"></a>
																<a href="javascript:;" onclick="window.open(&#39;https://www.cash669.net/m/login&#39;,&#39;_self&#39;)"><img src="/new/css/sbo.jpg"></a>
																<a href="javascript:;" onclick="window.open(&#39;https://www.cash669.net/m/login&#39;,&#39;_self&#39;)"><img src="/new/css/yybet.png"></a>
									</div>
				<div class="swiper-slide" style="width: 376px;">
										<!-- 						<a href="javascript:;"  onclick="window.open('https://www.cash669.net/m/login','_self')" ><img src="/wap/images/bbincp.jpg"></a>
					 -->
				</div>
			</div>
		<span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
	...
	<div class="noticeAltbox">
		...
		<div class="altButtonbox">
			<a href="https://www.cash669.net/m" id="login_url" target="_blank">直接進入遊戲</a>
	...
	<script type="text/javascript">
		...
		$('#trans_all').click(function (){
			if (sign){
				...
				$.post('https://www.cash669.net/api/trans_all', function (data) {
					if ( data['code'] == 0 ) {
						_this.html('資金回收');
		...
		$('#rightEnter').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: 'https://www.cash669.net/m/transfer',
				data: {
					out_account: 'center',
