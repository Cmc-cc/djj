<!DOCTYPE html>
<!-- saved from url=(0034)https://www.cash669.net/m/userinfo -->
...
<div class="inforTxt">
	<ul>
     ...
     <!--   	<div class="inforLeft">-->
     <!--       	<h2>{{trans("lang.bdsj")}}</h2>-->
     <!--       </div>-->
     <!--       <a href="/m/bindphone" class="changebtn">更換</a>-->
	    <!--</li>-->
	    <li>
		   
        	<div class="inforLeft">
            	<h2>{{trans("lang.xgmm")}}</h2>
            </div>
            <a href="/m/reset_password" class="changebtn">更換</a>
	    </li>
	    <li>
		   
        	<div class="inforLeft">
            	<h2>{{trans("lang.xgzfmm")}}</h2>
            </div>
            <a href="/m/reset_password2" class="changebtn">更換</a>
	    </li>
    </ul>
</div>
