			...
			<div class="content">
				<div class="all-info">
					<div class="make-money">
						<p>{{trans("lang.zongchenggongtixian")}}: </p>  
												...
												/*$('#general-msg').append(`<tr class="haveRead MColor1" style="display: table-row;">
													...
													$('#list').append(`<div class="list" onclick="qiehuan(this)">
														<div class="list-top">
															...
															<div class="list-top2">
																<div>{{trans("lang.jiaoyijine")}}: <strong style="color:red;">$ `+item.money+`</strong></div>
														...
														<div class="list-bottom">
															...
															<div><span>{{trans("lang.jiaoyijine")}}</span><span>`+item.money+`</span></div>
															<div><span>{{trans("lang.jiaoyizhuangtai")}}</span> ` + zhuangtai2 + `</div>
