        ...
        <div class="userInfo wrap" style="padding: 10px;">
            ...
            <table class="text-center" width="100%"  border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        <span id="name" class="STYLE2">{{ \App\Models\Base::$BANK_TYPE[$item->bank_id] }}</span>
                    </td>
                </tr>
                <tr>
                    <td>银行账号</td>
                    <td>{{ $item->card_no }}<span class="btn" data-clipboard-target="#name" style="color: #e4393c">复制</span></td>
                </tr>
                <tr>
                    <td>开户人姓名</td>
                    <td>{{ $item->username }}<span class="btn" data-clipboard-target="#name" style="color: #e4393c">复制</span></td>
                </tr>
                <tr>
                    <td>开户地</td>
                    <td>{{ $item->bank_address }}<span class="btn" data-clipboard-target="#name" style="color: #e4393c">复制</span></td>
                </tr>
                 @endforeach
                </tbody>
            </table>
            ...
            <form id="form1" name="form1" action="{{ route('wap.post_bank_pay') }}" method="post">
                ...
                <button type="button" class="submit_btn ajax-submit-btn" id="SubTran" style="width: 100%">提交信息</button>
            </form>
