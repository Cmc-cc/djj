        ...
        <div class="main_wrap">
            ...
            <div class="content" style="">
                <div class="sports-site">
                   <div class="sport-playbtnCMD toplay" groupid="45" @if($_member) data-url="/game/playGame?plat_type=TFG&game_type=7&game_code=&devices=1" @else data-url="" @endif data-code="TFG" style="left: 970px;top: 93px;">
                    ...
                    <div class="sport-playbtnBBIN toplay asas" groupid="4" @if($_member) data-url="/game/playGame?plat_type=HG&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="HG">
                        <a groupid="4" class="openGame" gamename="HG" gametype="FT"  oncontextmenu="return false;"></a>
                    </div>
                    <div class="sport-playbtn toplay asas" groupid="91" @if($_member) data-url="/game/playGame?plat_type=CMD&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="CMD" style="top: 35px;">
                         <a groupid="91" class="openGame" gamename="CMD" gametype="0"  oncontextmenu="return false;"></a>
                    </div>
                    <div class="sport-playbtnCRSPORT toplay" @if($_member) data-url="/game/playGame?plat_type=SBO&game_type=5&game_code=&devices=1" @else data-url="" @endif data-code="SBO" style="top: 35px;">
