           ...
           <!--- <div class="col-lg-3">
                <div class="input-group">
                    ...
                    <select name="flag" id="flag" class="form-control">
                        <option value="">--请选择--</option>
                            <option value="1" @if($flag == $k) selected @endif>已结算</option>
                            <option value="2" @if($flag == $k) selected @endif>未结算</option>
                            <option value="0" @if($flag == $k) selected @endif>无效注单</option>
                    </select>
                </div>
            </div>----->
