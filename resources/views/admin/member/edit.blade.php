                ...
                <form class="form-horizontal cmxform" name="registerForm" id="form" action="{{ route('member.update', ['id' => $data->getKey()]) }}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="my-money" name=""  value="{{ $data->money }}" readonly />
                            </div>
                        </div>
                        {{--<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="ml_money" name="ml_money"  value="{{ $data->ml_money }}"/>
                            </div>
                        </div>
						<div class="form-group">
                                        <label for="keyword" class="col-sm-2 control-label">AG切换AGS</label>
                                        <div class="col-sm-7">
                                            <label><input type="radio" name="ag2ags" value="0" @if($data->ag2ags == 0)checked @endif>不切换</label>
                                            <label><input type="radio" name="ag2ags" value="1" @if($data->ag2ags == 1)checked @endif>切换</label>
                                        </div>
                        </div>
						<div class="form-group">
                                        <label for="keyword" class="col-sm-2 control-label">SUNBET切换SUNBETS</label>
                                        <div class="col-sm-7">
                                            <label><input type="radio" name="sunbet2sunbets" value="0" @if($data->sunbet2sunbets == 0)checked @endif>不切换</label>
                                            <label><input type="radio" name="sunbet2sunbets" value="1" @if($data->sunbet2sunbets == 1)checked @endif>切换</label>
                                        </div>
                        </div>
                        <div class="form-group">
