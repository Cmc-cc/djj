                ...
                <form class="form-horizontal cmxform" name="registerForm" id="form" action="{{ route('member_daili.update', ['id' => $data->getKey()]) }}}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="agent_uri" name="agent_uri" placeholder="不需要填写 http://"  value="{{ $data->agent_uri }}"/><br>
                                <font color="red">此处需要指向域名"A"记录或"CNAME"记录到服务器IP或别名</font><br><br><b>
                                    {{--<font color="DarkRed">接口开户或获取基础域名请联系：SKYPE-</font><font color="Green">aobet.cn</font>　　<a href="http://skype.gmw.cn/down/" target="_blank" >SKYPE官方下载地址</a></b>--}}
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="agent_uri" class="col-sm-2 control-label">代理分成</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="agent_fencheng" name="agent_fencheng" placeholder="代理分成请输入0-100" value="{{ $data->agent_fencheng }}"/><br>
                             </div>
                        </div>
                    </div><!-- /.box-body -->
