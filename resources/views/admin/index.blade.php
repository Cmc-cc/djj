    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <p style="float:left;width: 50%;">{{@$admin_log->createtime}}交班</p>
                        <p style="float:right;width: 50%;">总充值：{{@$admin_log->recharge}}</p>
                        <p style="float:left;width: 50%;">总红利：{{@$admin_log->dividend}}</p>
                        <p style="float:right;width: 50%;">总提现：{{@$admin_log->drawing}}</p>
                        <p style="float:left;width: 50%;">代理佣金：{{@$admin_log->daili}}</p>
                        
                        
                        
                        <p style="float:right;width: 50%;">盈利：{{@$admin_log->recharge- @$admin_log->drawing}}</p>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-red">
                    <div class="inner">
                        ...
                        <p style="float:right;width: 50%;">当月总充值：{{@$month['month_recharge']}}</p>
                        <p style="float:left;width: 50%;">当月总红利：{{@$month['month_dividend']}}</p>
                        <p style="float:right;width: 50%;">当月总提现：{{@$month['month_drawing']}}</p>
                        <p style="float:left;width: 50%;">当月代理佣金：{{@$month['daili']}}</p>
                        
                        
                        
                        <p style="float:right;width: 50%;">盈利：{{@$month['month_recharge']-$month['month_drawing']}}</p>
                        <p style="clear:both;"></p>
                    </div>
                    <div class="icon">
                        {{--<i class="ion ion-pie-graph"></i>--}}
