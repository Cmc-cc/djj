                        ...
                        <div role="tabpanel" class="tab-pane" id="profile">
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="rc_ml_percent" name="rc_ml_percent"  value="{{ $data->rc_ml_percent }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="sc_percent" name="sc_percent"  value="{{ $data->sc_percent }}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="new_sc_percent" name="new_sc_percent"  value="{{ $data->new_sc_percent }}" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="active_member_money" class="col-sm-2 control-label">新账号首冲送分打码量倍数</label>
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="hongli_new_percent" name="hongli_new_percent"  value="{{ $data->hongli_new_percent }}" />
                                        </div>
                                    </div>
                                    <!--<div class="form-group">-->
                                    ...
                                    <!--    <div class="col-sm-7">-->
                                    <!--        <input type="number" class="form-control" id="ks_ml_percent" name="ks_ml_percent"  value="{{ $data->ks_ml_percent }}" />-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <!--<div class="form-group">-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" class="form-control" id="water_percent" name="water_percent"  value="{{ $data->water_percent }}" />
                                        </div>
                                    </div>
                                <div class="box-footer">
                                    <div class="form-group">
                            ...
                            <form class="form-horizontal" id="form" action="{{ route('system_config.update', ['id' => 1]) }}" method="post">
                                ...
                                <div class="box-body">
								    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <label><input type="radio" name="mz_open"  value="0" @if($data->mz_open == 0)checked @endif />关闭</label>
                                            <label><input type="radio" name="mz_open"  value="1" @if($data->mz_open == 1)checked @endif />开启</label>
								    ...
								    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="wg_pl" name="wg_pl" placeholder="例：1980" value="{{ $data->wg_pl }}"  />(赔率格式 例如赔率为1.980就传入 1980-最高不能超过2000-最低不能低于1800)
                                        </div>
                                    </div>
                                   {{--  <div class="form-group">
                                        <label for="wg_wf" class="col-sm-2 control-label"><span style="color: red">WG玩法</span></label>
                                        <div class="col-sm-7">
										<label><input type="radio" name="wg_wf"  value="1" @if($data->wg_wf == 1)checked @endif />官方玩法(目前不支持)</label>
                                            <label><input type="radio" name="wg_wf"  value="2" @if($data->wg_wf == 2)checked @endif />信用玩法(目前不支持</label>
											(例:赔率为 1.98官方玩法 Additional传入数据为 1980,1)
                                        </div>
                                    </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
										    <select name="sunbet_xh" class="form-control" id="sunbet_xh">
											    <option value="1" @if($data->sunbet_xh == 1)selected @endif >青铜-基本额度</option>
												<option value="2" @if($data->sunbet_xh == 2)selected @endif >白银-升级额度</option>
												<option value="3" @if($data->sunbet_xh == 3)selected @endif >黄金-高级额度</option>
												<option value="4" @if($data->sunbet_xh == 4)selected @endif >白金-贵宾额度</option>
											</select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select name="vg_xh" class="form-control" id="vg_xh">
											    <option value="1" @if($data->vg_xh == 1)selected @endif >青铜-基本额度</option>
												<option value="2" @if($data->vg_xh == 2)selected @endif >白银-升级额度</option>
												<option value="3" @if($data->vg_xh == 3)selected @endif >黄金-高级额度</option>
												<option value="4" @if($data->vg_xh == 4)selected @endif >白金-贵宾额度</option>
											</select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select name="mx_xh" class="form-control" id="mx_xh">
											    <option value="1" @if($data->mx_xh == 1)selected @endif >青铜-基本额度</option>
												<option value="2" @if($data->mx_xh == 2)selected @endif >白银-升级额度</option>
												<option value="3" @if($data->mx_xh == 3)selected @endif >黄金-高级额度</option>
												<option value="4" @if($data->mx_xh == 4)selected @endif >白金-贵宾额度</option>
											</select>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
