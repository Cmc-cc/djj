<header class="main-header">
    ...
    <a href="javascript:;" class="logo">
        ...
        <span class="logo-lg"><b>{{ $_system_config->site_name }}管理系统</b></span>
    </a>
...
<audio id="dl" src="{{ asset('/backstage/audio/dl.mp3') }}"></audio>

<audio id="hd" src="{{ asset('/backstage/audio/hd_notice.mp3') }}"></audio>
<script>

	var hd_url = "{{ route('admin.hd_notice') }}";
    $(function(){
		var hd_timer=setInterval(function(){
            $.ajax({
                url:hd_url,
                data:'',
                dataType:'json',
                ...
                success:function(data){
                    if(data.status == 1){
                        document.getElementById('hd').play();
						$.toast({
							text: "您有新的活动申请信息<a href='/admin/activity'>点击查看</a>",
							heading: '活动申请提示',
							icon: 'info',
...
<script>
    ...
    var dl_url = "{{route('admin.dl_notice')}}";
