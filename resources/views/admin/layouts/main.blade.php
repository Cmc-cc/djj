...
<head>
    ...
    <title>{{ $_system_config->site_name }}-管理后台</title>
    ...
    <link rel="stylesheet" href="{{ asset('/backstage/css/admin.css') }}">
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            @include('admin.layouts.alertMsg')
        </section>
...
<script src="{{ asset('/vendor/layer/layer.js?r=1') }}"></script>
...
<script src="{{ asset('/backstage/js/layer-date-default.js') }}"></script>
<script>
    $.ajaxSetup({
        headers: {
