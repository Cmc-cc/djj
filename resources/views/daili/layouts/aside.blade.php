<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active"><a href="{{ route('daili.index') }}"><i class="fa fa-dashboard"></i> <span>代理首页</span></a></li>
            <li class="treeview">
                <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li @if($active_route == 'daili.member_daili') class="active" @endif><a href="{{ route('daili.member_daili') }}"><i class="fa fa-circle-o"></i> 推广网址</a></li>
