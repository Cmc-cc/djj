    ...
    <div class="top">
        ...
        <ul class="topList">
            ...
            {{--style="color:#00b0f0;">支付宝秒充值</em></a></li>--}}
                    <!--<li> <a  target="_blank" href="MegawinCasino_Game.html?gameId=50" class="red">千炮捕鱼</a>  </li>-->
            <!--<li> <a href="http://www.hdsq.am" target="_blank">活动申请</a>  </li>-->
            {{--<li><a href="javascript:;">电子十二惠专题</a></li>--}}
            {{--<li><a href="javascript:;" target="_blank">日工资周俸禄</a></li>--}}
       {{--  <li><a href="javascript:;" target="_blank">线路检测</a></li>--}}
			 <li><a href="javascript:;" class="daili_apply">代理加盟</a>&nbsp;|&nbsp;
              <li><a href="{{route('daili.init')}}" target="_blank">代理登录</a>&nbsp;|&nbsp;
        ...
        <ul class="nav">
            ...
            <li>
                <a href="{{ route('web.eGame') }}"
                   class="blinkRed @if($web_route == 'web.eGame') current @endif">电子游戏<span class="en">Slots</span>
                </a>
                <span class="hotpic">
            ...
            <li>
                <a href="{{ route('web.catchFish') }}"
                   class="blinkRed @if($web_route == 'web.catchFish') current @endif">捕鱼游戏 <span
            ...
            <!--体育竞猜-->
            <li>
                <a href="{{ route('web.esports') }}" @if($web_route == 'web.esports') class="current" @endif>体育竞技 <span
                ...
                @else
                    <div class="ember-view memberinfo">
                        <div class="memberMeun">
							 @if(!$_system_config->mz_open)
								<a title="额度转换" href="{{ route('member.indoor_transfer') }}">额度转换</a>|
							 @endif
                
                            
                            @if($_system_config->is_new_center==1)
                                <a title="账户管理" href="{{ route('member.userCenter') }}?type=6">个人资料</a>|
							    <a title="我要存款" href="{{ route('member.userCenter') }}?type=1">存取款</a>|                              						
                               <a title="账户记录" href="{{ route('member.userCenter') }}?type=3">账户记录</a>|
                               <a title="账户管理" href="{{ route('member.userCenter') }}?type=5">站内消息</a>|
                        ...
                        <div class="membe-left">
                            ...
                            <div class="balance">余额：<strong class="money">{{ $_member->all_money }}</strong></div>
							<div class="balance">剩余码量：<strong class="money">{{ $_member->ml_money }}</strong></div>
