            ...
            <div class="SU-Menual">
                <ul class="login-Menual">
                    @if($_system_config->is_new_center ==1)
                        <li>
                            <a id="su-macenter" href="{{ route('member.userCenter') }}?type=6" title="会员中心">会员中心</a>
                            ｜
                        </li>
						 <li>
                            <a id="su-macenter" href="{{ route('member.userCenter') }}?type=1" title="存取款">存取款</a>
                            ｜
                        </li>
						
						 <li>
                            <a id="su-macenter" href="{{ route('member.userCenter') }}?type=4" title="账户记录">账户记录</a>
                            ｜
                        </li>
