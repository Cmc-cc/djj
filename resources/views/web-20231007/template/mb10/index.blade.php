@extends('web.template.mb10.layouts.main')
@section('after.js')
                ...
                <div class="indexmain">
                    <div class="indexbanner" id="indexbanner">
                        <div class="lunbo w1000" style="overflow: hidden;">
                            ...
                            <div class="bd">
                                <ul class="w1000">
                                    {{--<li style="display: none;"><a href="#"><img src="{{ asset('/web/mb10/images/newYear.png') }}"></a></li>
                                    <li style="display: none;"><a href="#"><img src="{{ asset('/web/mb10/images/sd1.png') }}"></a></li>
                                    <li style="display: none;"><a href="#"><img src="{{ asset('/web/mb10/images/banner02.png') }}"></a></li>
                                    <li style=""><a href="#"><img src="{{ asset('/web/mb10/images/banner03.png') }}"></a></li>--}}
                                    @foreach($banners as $item)
                                        <li style=""><a href="{{$item->jumpurl}}" target="_blank"><img src="{{$item->path}}"></a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="gonggao" id="newsBar"><!--公告栏 start-->
                            ...
                            <div class="zxxx">
                                <div class="noticeContent">
                                    <span class="noticeTitle">最新消息：</span>
                    ...
                    <div class="mainlink w1000">
                        ...
                        <a href="#" target="_blank" class="zixun"></a>
                    </div>
