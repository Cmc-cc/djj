    ...
    <div class="header">
        <div class="w clearfix">
            ...
            <div class="head-r fr">
                <div class="head-tips">
                    会员大额提现均可在 <br>
                    {{ $_system_config->site_name }}酒店进行提现 <br>
                ...
                @else
                    <div class="dengul">
                        <div class="denghobx" style="display: initial;">
                            ...
                            <span class="huang pr30"> 余额： <strong class="money">{{ $_member->all_money }} </strong></span>
							 <span class="huang pr30"> 剩余码量： <strong class="money">{{ $_member->ml_money }} </strong></span>
    ...
    <div class="bandeng">
        ...
        @else
            <div class="denghoms">
                ...
                <br>
                <span style="margin-bottom: 15px;display: block">账户余额 : <strong class="money">{{ $_member->all_money }}</strong>
				</strong>剩余码量 : <strong class="money">{{ $_member->ml_money }}</strong></span>
                @if($_system_config ->is_new_center == 1)
                          <a href="{{ route('member.userCenter') }}?type=6">会员中心</a>｜
								 <a href="{{ route('member.userCenter') }}?type=1">存取款</a>｜							  
							   <a href="{{ route('member.userCenter') }}?type=4">账户记录</a>｜
