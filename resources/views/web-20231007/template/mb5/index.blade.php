...
{{--<div class="modal-content" style="width: 650px;height: 414px;padding: 0">--}}
{{--<a href="" class="close bg-icon" style="top: 0;right: -20px;opacity: 1;background-color: #ccc"></a>--}}
{{--<a href="http://wpa.qq.com/msgrd?v=3&uin=824700&site=qq&menu=yes">--}}
    ...
    <div class="mainBox2-inner">
        <div class="w">
            <div class="hd J-nav-tab">
                <ul>
                    <li class="li1">
                        <a onclick="javascript:window.open('{{ route('mg.playGame') }}?gamename=MyGameLobby','','width=1024,height=768')" class="on">
                            <div class="img">
                    ...
                    <li class="li3">
                        <a onclick="javascript:window.open('{{ route('bbin.playGame') }}?gamename=game','','width=1024,height=768')">
                            <div class="img">
                    ...
                    <li class="li4">
                        <a onclick="javascript:window.open('{{ route('ag.playGame') }}?gamename=MyGameLobby','','width=1024,height=768')">
                            <div class="img">
                    ...
                    <li class="li2">
                        <div class="li4">
                            <a onclick="javascript:window.open('{{ route('pt.playGame') }}?gamename=MyGameLobby','','width=1024,height=768')">
                            <div class="img">
                    ...
                    <li class="li5">
                        <a onclick="javascript:window.open('{{ route('pp.playGame') }}?gamename=MyGameLobby','','width=1024,height=768')">
                        <div class="li4">
                            <div class="img">
        ...
        <div class="w">
            <div class="manu_t">
                <ul>
                    ...
                    <li class="st_c">
                        <div class="or_1">
                            <a href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=MG','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录!',{icon:6})" @endif>
                    ...
                    <li class="st_d" style="cursor:pointer;">
                        <div class="or_1">
                            <a href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=BBIN&gamename=live','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录!',{icon:6})" @endif>
...
<div class="mainBox4">
    <div class="w">
        <div class="mainBox4-inner">
            ...
            <p>
                手机投注平台面向全网玩家，提供近万款电子游艺、老虎机、百家乐以及彩票
                游戏、体育投注，线上存款及线上取款，一键操作， 运用3D即时运算创造真实
