...
<div class="header">
    <div class="wrap">
        <div class="top">
            ...
            <div class="right">
                {{--<a href="{{ route('web.eGame') }}?api_name=MG" class="mg-game">MG电子游戏</a>&nbsp;|&nbsp;--}}
                {{--<a href="{{ route('web.eGame') }}?api_name=PT" class="pt-game">PT电子游戏</a>&nbsp;|&nbsp;--}}
                {{--<a href="{{ route('web.eGame') }}?api_name=BBIN" class="bb-game">BB电子游戏</a>&nbsp;|&nbsp;--}}
                ...
                {{--@else onclick="return layer.msg('请先登录!',{icon:6})" @endif>AG电子游戏</a>&nbsp;|&nbsp;--}}
            ...
            @else
                <div class="after-login">
                    <div class="hd">
                        ...
                        余额： <span class="yellowCr money">{{ $_member->all_money }}</span> &nbsp;
            ...
            <ul class="list">
                ...
                <li @if($web_route == 'web.eGame') class="active" @endif>
                    <a href="{{ route('web.eGame') }}">
                        <span class="tit e-game">电子游艺</span>
                    </a>
                    <img src="{{ asset('/web') }}/images/hot.gif" class="hot">
                    <div class="second-nav">
                ...
                <li @if($web_route == 'web.esports') class="active" @endif>
                    <a href="{{ route('web.esports') }}">
                        <span class="tit">体育赛事</span>
                    </a>
                    <div class="second-nav">
                        @if(in_array('GJ', $_api_list))
                            <a href="javascript:;"
                               @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=GJ&gamename=SP3','','width=1024,height=768')"
                    ...
                    <div class="second-nav">
						...
						@if(in_array('761', $_api_list))
							 <a href="javascript:;"
                               ...
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>761棋牌</a>  
                    ...
                    <div class="second-nav">
						...
						@if(in_array('PG', $_api_list))
                            <a href="javascript:;"
                               ...
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>PG鱼王争霸</a>
                        @endif
						@if(in_array('PG', $_api_list))
                            <a href="javascript:;"
                               @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=PG&gamename=4003','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>PG全民捕鱼彩金 </a>
                        @endif
						@if(in_array('PG', $_api_list))
                            <a href="javascript:;"
                               @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=PG&gamename=4004','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>PG全民捕鱼</a>
                        @endif
                        ...
                        @if(in_array('DSQP', $_api_list))
                            <a href="javascript:;"
                               ...
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>DS海霸王</a>
                        @endif
                        @if(in_array('DSQP', $_api_list))
                            <a href="javascript:;"
                               @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=DSQP&gamename=1002','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>DS吃我一炮</a>
                        @endif
                        ...
                        @if(in_array('MW', $_api_list))
                            <a href="javascript:;"
                               ...
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>MW千炮捕鱼</a>
                        @endif 
                        @if(in_array('PT', $_api_list))
                            <a href="javascript:;"
