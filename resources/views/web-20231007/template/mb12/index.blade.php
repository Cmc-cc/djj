        ...
        <div class="con">
            <div class="wrap">
                <ul class="top">
                    ...
                    <li class="active">
                        <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb12/images/mg.png"><p class="tit">MG电子</p></a>
                    </li>
                    @endif
                        @if(in_array('PT', $_api_list))
                    <li>
                        <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb12/images/pt.png"><p class="tit">PT电子</p></a>
                    </li>
                        @endif
                        @if(in_array('AG', $_api_list))
                    <li>
                        <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb12/images/ag.png"><p class="tit">AG电子</p></a>
                    </li>
                        @endif
                        @if(in_array('BBIN', $_api_list))
                    <li>
                        <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb12/images/bb.png"><p class="tit">BBIN电子</p></a>
                    </li>
                        @endif
                        @if(in_array('MW', $_api_list))
                    <li>
                        <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb12/images/mw.png"><p class="tit">MW电子</p></a>
                    </li>
                        @endif
                        @if(in_array('GPI', $_api_list))
                    <li>
                        <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb12/images/gpi.png"><p class="tit">GPI电子</p></a>
                    </li>
                        @endif
                        @if(in_array('ttt', $_api_list))
                    <li>
                        <a href="javascript:void(0)"><img src="{{ asset('/web') }}/mb12/images/prg.png"><p class="tit">PP电子</p></a>
                    </li>
                        @endif
                </ul>
                <div class="bot">
                    <div class="left module">
                        <ul>
                            @if(in_array('MG', $_api_list))
                            <li>
                                <a href="{{ route('mg.playGame') }}?gamename=MyGameLobby" target="_blank">
                        ...
                        <ul class="hide">
                            @if(in_array('PT', $_api_list))
                            <li>
                                <a href="{{ route('pt.playGame') }}?gamename=MyGameLobby" target="_blank">
                        ...
                        <ul class="hide">
                            @if(in_array('AG', $_api_list))
                            <li>
                                <a href="{{ route('ag.playGame') }}?gamename=MyGameLobby" target="_blank">
                        ...
                        <ul class="hide">
                            @if(in_array('BBIN', $_api_list))
                            <li>
                                <a href="{{ route('bbin.playGame') }}?gamename=MyGameLobby" target="_blank">
                        ...
                        <ul class="hide">
                            @if(in_array('MW', $_api_list))
                            <li>
                                <a href="{{ route('wg.playGame') }}?plat_type=mw&gamename=MyGameLobby" target="_blank">
                        ...
                        <ul class="hide">
                            @if(in_array('GPI', $_api_list))
                            <li>
                                <a href="{{ route('wg.playGame') }}?plat_type=gpi&gamename=MyGameLobby" target="_blank">
                        ...
                        <ul class="hide">
                            ...
                            <li>
                                <a href="{{ route('wg.playGame') }}?plat_type=pp&gamename=MyGameLobby" target="_blank">
