                ...
                <ul class="navbar-nav navbar-right nav nav-user">
                    <li class="menu-user">
                        ...
                        <div style="display:inline-block;padding: 17px 0 0px 10px;float: left">
							...
							<a href="{{route('member.userCenter') }}?type=6">会员中心</a></span>&nbsp;|&nbsp;
							<a href="{{ route('member.userCenter') }}?type=1">存取款</a></span>&nbsp;|&nbsp;							
							<a href="{{ route('member.userCenter') }}?type=4">账户记录</a></span>&nbsp;|&nbsp;
                    ...
                    <li class="menu-user-found">
                        <div style="padding: 14px 0px;">
                            可用余额：<span class="user-balance" style="cursor: pointer;" title="可用余额"
                                       id="user-balance"><strong class="money">{{ $_member->all_money }}</strong></span>
                             <a href="" style="line-height: 20px;margin-left: 5px;">[刷新]</a>
							 剩余码量：<span class="user-balance" style="cursor: pointer;" title="可用余额"
                                       id="user-balance"><strong class="money">{{ $_member->ml_money }}</strong></span>
                             <a href="" style="line-height: 20px;margin-left: 5px;">[刷新]</a>
