    ...
    <div class="tai_header-top">
        <div class="container">
            ...
            <ul class="top-nav">
				...
				<li>
                    <a style="color: red" target="_blank" href="{{route('daili.init')}}">代理登录</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                </li>
                <li>
    ...
    <div class="tai_nav">
        ...
        <ul class="pullRight">
            ...
            <li class="has-menu @if($web_route == 'web.liveCasino')on @endif">
                ...
                {{--<ol class="subnav">--}}
                {{--<li @if($_member) onclick="javascript:window.open('{{ route('cgc.playGame') }}?id=12','','width=1024,height=768')"--}}
                {{--@else onclick="return layer.msg('请先登录!',{icon:6})"  @endif>AG国际厅</li>--}}
                {{--<li @if($_member) onclick="javascript:window.open('{{ route('cgc.playGame') }}?id=13','','width=1024,height=768')"--}}
                {{--@else onclick="return layer.msg('请先登录!',{icon:6})"  @endif>AG旗舰厅</li>--}}
                {{--<li @if($_member) onclick="javascript:window.open('{{ route('cgc.playGame') }}?pageSite=live','','width=1024,height=768')"--}}
                {{--@else onclick="return layer.msg('请先登录!',{icon:6})" @endif>BB旗舰厅</li>--}}
                {{--<li @if($_member) onclick="javascript:window.open('{{ route('cgc.playGame') }}','','width=1024,height=768')"--}}
            ...
            <li @if($web_route == 'web.poker') class="on" @endif>
            ...
            <li>
                <a href="{{route('daili.init')}}" target="_blank">
                    代理登录
                    <span>AGENT</span>
                </a>
            </li>
            ...
            @else
                <div class="">
                    <ul class="account-info">
                        ...
                        <li>
                            账户余额 :
                            <span class="account">$<strong class="money">{{ $_member->all_money }}</strong>&nbsp;</span>
                        </li>
						 <li>
                            剩余码量 :
                            <span class="account">$<strong class="money">{{ $_member->ml_money }}</strong>&nbsp;</span>
                        </li>
                    ...
                    <ul class="account-nav">
                        @if($_system_config->is_new_center ==1)
                            <li>
                                <a href="{{ route('member.userCenter') }}?type=6">
                                    个人中心
                                </a>
                            </li>
							 <li>
                                <a href="{{ route('member.userCenter') }}?type=1">
                                    存取款
                                </a>
                            </li>													
							 <li>
                                <a href="{{ route('member.userCenter') }}?type=4">
                                    账户记录
                                </a>
                            </li>
                            @else
