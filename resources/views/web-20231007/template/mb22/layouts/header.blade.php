             ...
             <a href="{{ route('web.index') }}" class="logo">
              <img src="{{ $_system_config->site_logo}}">
			    ...
			    <ul class="list-unstyled _vr_nav">
					...
					<li class="subnav" rel="sub-casino"> <a data-page="casino.html" class="dropdown-toggle" href="{{ route('web.eGame') }}">电子游艺<span>CASINO</span></a></li>
					<li class="subnav hot nav-blink2" rel="sub-live"> <a data-page="live.html" class="dropdown-toggle" href="{{ route('web.liveCasino') }}">真人视讯<span>LIVE</span></a></li>
					<li class="subnav" rel="sub-sports"> <a data-page="sports.html" class="dropdown-toggle" href="{{ route('web.esports') }}">体育竞技<span>SPORT</span></a></li>
           ...
           <ul class="list-table">
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="22"@if($_member) href="{{ route('wg.playGame') }}?plat_type=VR" target="_blank" @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="4"> <span class="apiicon vr shake shake-little"></span> <p> <i>VR真人彩票</i> 高画质专业彩票平台,提供多元化视频传输 </p> </a>
              </dt> 
              <dd> 
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="22" @if($_member) href="{{ route('wg.playGame') }}?plat_type=VR" @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="4">立即游戏</a> </p>
              </dd> 
             </dl> </li>
            @endif
            ...
            <li>
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="2"@if($_member) href="{{ route('wg.playGame') }}?plat_type=BBIN" target="_blank" @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="4"> <span class="apiicon bb shake shake-little"></span> <p> <i>bb彩票</i> 北京、澳洲等快乐彩玩法多样，惊喜连连。法模式，玩法赔率业界最高。 </p> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="2"@if($_member) href="{{ route('wg.playGame') }}?plat_type=BBIN" target="_blank" @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="4">立即游戏</a> </p>
              </dd> 
             </dl> </li>
            @endif
            <!--<li>
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="10" @if($_member) href="{{ route('wg.playGame') }}?gametype=ltlottery" target="_blank" @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="4"> <span class="apiicon bb shake shake-little"></span> <p> <i>BB彩票</i> 六合彩、时时彩、快乐彩等彩种最全的平台。 </p> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="10" @if($_member) href="{{ route('wg.playGame') }}?gametype=ltlottery" target="_blank" @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="4">立即游戏</a> </p> 
              </dd> 
             </dl> </li--> 
           </ul> 
          </div> 
          ...
          <div class="api-games"> 
           <ul class="list-table">
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="10" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=BBIN&gamename=live','','width=1024,height=768')"
									   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1"> <span class="apiicon bb shake shake-little"></span> <i>BB富贵厅</i> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="10" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=BBIN&gamename=live','','width=1024,height=768')"
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="9" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=AG','','width=1024,height=768')"
									   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1"> <span class="apiicon ag shake shake-little"></span> <i>AG女优厅</i> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="9" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=AG','','width=1024,height=768')"
									   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1">立即游戏</a> </p> 
              </dd> 
             </dl> </li>
            @endif
            ...
            <li>
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="33" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=SUNBET','','width=1024,height=768')"
              ...
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="33" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=SUNBET','','width=1024,height=768')"
									   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1">立即游戏</a> </p> 
              </dd> 
             </dl> </li>
             @endif
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="7" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=OG','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1"> <span class="apiicon og shake shake-little"></span> <i>OG东方厅</i> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="7" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=OG','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1">立即游戏</a> </p> 
              </dd> 
             </dl> </li>
             @endif
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="17" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=SA','','width=1024,height=768')"
									   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1"> <span class="apiicon sa shake shake-little"></span> <i>SA澳门厅</i> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="17" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=SA','','width=1024,height=768')"
									   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1">立即游戏</a> </p> 
              </dd> 
             </dl> </li>
             @endif
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="5" href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=GD','','width=1024,height=768')"
                  @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1"> <span class="apiicon gd shake shake-little"></span> <i>GD锦绣厅</i> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="5" href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=GD','','width=1024,height=768')"
                     @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="1">立即游戏</a> </p>
              </dd> 
             </dl> </li>
             @endif
          ...
          <div class="api-games"> 
           <ul class="list-table">
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="12" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=GJ','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href="{{ route('wg.playGame') }}?gametype=ball"> <span class="apiicon hg shake shake-little"></span> <p> <i>皇冠体育</i> 提供足球、篮球等最完整、最准确、最即时的的体育赛事信息。 </p> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="12" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=GJ','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href="{{ route('wg.playGame') }}?gametype=ball">立即游戏</a> </p> 
              </dd> 
             </dl> </li>
            @endif
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="19" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=IBC','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href="{{ route('wg.playGame') }}?gametype=ball"> <span class="apiicon sb shake shake-little"></span> <p> <i>沙巴体育</i> 多元化滚球玩法，快速投注完美结合，亚洲最受欢迎的线上体育专家。 </p> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="19" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=IBC','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href="{{ route('wg.playGame') }}?gametype=ball">立即游戏</a> </p> 
              </dd> 
             </dl> </li>
             @endif
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="36" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=BBIN&gamename=ball','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href="{{ route('wg.playGame') }}?gametype=ball"> <span class="apiicon ysb shake shake-little"></span> <p> <i>BBIN体育</i> 提供的足球、篮球、亚洲乐透、亚洲赛马、赛狗和世界各地的股票指数都应有尽有。 </p> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="36" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=BBIN&gamename=ball','','width=1024,height=768')"
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href="{{ route('wg.playGame') }}?gametype=ball">立即游戏</a> </p> 
              </dd> 
             </dl> </li>
             @endif
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="4" href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=IM','','width=1024,height=768')"
                  @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href=""> <span class="apiicon im shake shake-little"></span> <p> <i>IM体育</i> 每月提供超过10，000场各类赛事，是亚洲最大的体育平台供应商之一。 </p> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="4" href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=IM','','width=1024,height=768')"
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="37" href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=AG&gamename=TASSPTA','','width=1024,height=768')"
                  @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href=""> <span class="apiicon ag shake shake-little"></span> <p> <i>AG体育</i> 足球、篮球等最完整最即时赛事投注 </p> </a>
              </dt> 
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="37" href="javascript:void(0)" @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=AG&gamename=TASSPTA','','width=1024,height=768')"
                     @else onclick="return layer.msg('请先登录！',{icon:6})" @endif data-apitype="3" data-href="">立即游戏</a> </p>
              </dd> 
             </dl> </li>
              @endif
          ...
          <div class="api-games"> 
           <ul class="list-table">
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="3" href="{{route('wg.playGame')}}?plat_type=MG&gamename=MyGameLobby" data-apitype="2" data-mt-ic="_vr_mt_casino_3" target="_blank"> <span class="apiicon mg shake shake-little"></span> </a>
              </dt> 
              <dd> 
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="3" href="{{route('wg.playGame')}}?plat_type=MG&gamename=MyGameLobby" data-apitype="2"  data-mt-ic="_vr_mt_casino_3"> MG电子 </a> </p>
              </dd> 
             </dl>
            </li>
            @endif
            ...
            <li>
             <dl class="sub-box api-item">
              <dt>
               <a target="_blank" class="shake shake-opacity _vr_mt_check" data-api="38" href="{{route('wg.playGame')}}?plat_type=MG&gamename=MyGameLobby" data-apitype="2" data-href="" data-mt-ic="_vr_mt_casino_38"> <span class="apiicon prg shake shake-little"></span> </a>
              </dt>
              <dd>
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="38" href="{{route('wg.playGame')}}?plat_type=MG&gamename=MyGameLobby" data-apitype="2" data-href="" data-mt-ic="_vr_mt_casino_38"> PP电子 </a> </p>
              </dd>
             </dl> </li>
             @endif
            ...
            <li>
             <dl class="sub-box api-item">
              <dt>
               <a target="_blank" class="shake shake-opacity _vr_mt_check" data-api="25" href="{{route('wg.playGame')}}?plat_type=SG&gamename=MyGameLobby" data-apitype="2" data-href="" data-mt-ic="_vr_mt_casino_25"> <span class="apiicon sg shake shake-little"></span> </a>
              </dt>
              <dd>
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="25" href="{{route('wg.playGame')}}?plat_type=SG&gamename=MyGameLobby" data-apitype="2" data-href="" data-mt-ic="_vr_mt_casino_25"> SG电子 </a> </p>
              </dd>
             </dl> </li>
             @endif
            <!--<li>
             <dl class="sub-box api-item">
              ...
              <dd>
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="20" href="javascript:void(0)" data-apitype="2" data-href="" data-mt-ic="_vr_mt_casino_20"> BSG电子 </a> </p>
              </dd>
             </dl> </li>-->
            ...
            <li>
             <dl class="sub-box api-item">
              <dt>
               <a target="_blank" class="shake shake-opacity _vr_mt_check" data-api="35" href="{{route('wg.playGame')}}?plat_type=MW&gamename=MyGameLobby" data-apitype="2"  data-mt-ic="_vr_mt_casino_35"> <span class="apiicon mw shake shake-little"></span> </a>
              </dt>
              <dd>
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="35" href="{{route('wg.playGame')}}?plat_type=MW&gamename=MyGameLobby" data-apitype="2" data-mt-ic="_vr_mt_casino_35"> MW电子 </a> </p>
              </dd>
             </dl> </li>
             @endif
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a target="_blank" class="shake shake-opacity _vr_mt_check" data-api="6" href="{{route('wg.playGame')}}?plat_type=PT&gamename=MyGameLobby" data-apitype="2"  data-mt-ic="_vr_mt_casino_6"> <span class="apiicon pt shake shake-little"></span> </a>
              </dt> 
              <dd> 
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="6" href="{{route('wg.playGame')}}?plat_type=PT&gamename=MyGameLobby" data-apitype="2"  data-mt-ic="_vr_mt_casino_6"> PT电子 </a> </p>
              </dd> 
             </dl> </li>
             @endif
            <!--li>
             <dl class="sub-box api-item"> 
              ...
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="26" href="{{ route('web.eGame') }}?api_name=PNG" data-apitype="2" data-href="{{ route('web.eGame') }}?api_name=PNG" data-mt-ic="_vr_mt_casino_26"> PNG电子 </a> </p>
              </dd> 
             </dl> </li>
           </ul>
           <ul class="list-table"-->
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a  target="_blank" class="shake shake-opacity _vr_mt_check" data-api="9" href="{{route('wg.playGame')}}?plat_type=AG&gamename=MyGameLobby"  data-apitype="2"  data-mt-ic="_vr_mt_casino_9"> <span class="apiicon ag shake shake-little"></span> </a>
              </dt> 
              <dd> 
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="9" href="{{route('wg.playGame')}}?plat_type=AG&gamename=MyGameLobby" data-apitype="2" data-mt-ic="_vr_mt_casino_9"> AG电子 </a> </p>
              </dd> 
             </dl> </li>
             @endif
             @if(in_array('BBIN', $_api_list))
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a target="_blank" class="shake shake-opacity _vr_mt_check" data-api="10" href="{{route('wg.playGame')}}?plat_type=BBIN&gamename=MyGameLobby" data-apitype="2"  data-mt-ic="_vr_mt_casino_10"> <span class="apiicon bb shake shake-little"></span> </a>
              </dt> 
              <dd> 
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="10" href="{{route('wg.playGame')}}?plat_type=BBIN&gamename=MyGameLobby" data-apitype="2"  data-mt-ic="_vr_mt_casino_10"> BB电子 </a> </p>
              </dd> 
             </dl> </li>
            @endif
            <!--li> 
             <dl class="sub-box api-item"> 
              ...
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="15" href="javascript:void(0)" data-apitype="2" data-href="" data-mt-ic="_vr_mt_casino_15"> HABA电子 </a> </p> 
              </dd> 
             </dl> </li-->
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a target="_blank" class="shake shake-opacity _vr_mt_check" data-api="27" href="{{route('wg.playGame')}}?plat_type=DT&gamename=MyGameLobby" data-apitype="2" data-mt-ic="_vr_mt_casino_27"> <span class="apiicon dt shake shake-little"></span> </a>
              </dt> 
              <dd> 
               <p><a target="_blank" class="enter-link _vr_mt_check _vr_mt_slogan" data-api="27" href="{{route('wg.playGame')}}?plat_type=DT&gamename=MyGameLobby" data-apitype="2" data-mt-ic="_vr_mt_casino_27"> DT电子 </a> </p>
              </dd> 
             </dl> </li>
            @endif
            ...
            <!--li> 
             <dl class="sub-box api-item"> 
              ...
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="28" href="javascript:void(0)" data-apitype="2" data-href="" data-mt-ic="_vr_mt_casino_28"> GG捕鱼 </a> </p> 
              </dd> 
             </dl> </li--> 
           </ul> 
          </div> 
          ...
          <div class="api-games"> 
           <ul class="list-table">
            ...
            <li> 
             <dl class="sub-box api-item"> 
              <dt>
               <a class="shake shake-opacity _vr_mt_check" data-api="34" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=KY','','width=1024,height=768')"
              ...
              <dd> 
               <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="34" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=KY','','width=1024,height=768')"
            ...
            @endif
             @if(in_array('VG', $_api_list))
              <li>
               <dl class="sub-box api-item">
                <dt>
                 <a class="shake shake-opacity _vr_mt_check" data-api="34" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=NEWVG','','width=1024,height=768')"
                ...
                <dd>
                 <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="34" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=NEWVG','','width=1024,height=768')"
                       @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="5">立即游戏</a> </p>
                </dd>
               </dl> </li>
             @endif
             @if(in_array('LEG', $_api_list))
              <li>
               <dl class="sub-box api-item">
                <dt>
                 <a class="shake shake-opacity _vr_mt_check" data-api="34" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=JS','','width=1024,height=768')"
                    @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="5" data-href="" data-mt-ic="_vr_mt_casino_34"> <span class="apiicon ly shake shake-little"></span> <p> <i>金龙棋牌</i> 多款主流游戏可供选择，覆盖区域广 </p> </a>
                </dt>
                <dd>
                 <p><a class="enter-link _vr_mt_check _vr_mt_slogan" data-api="34" href="javascript:void(0)"@if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=JS','','width=1024,height=768')"
                       @else onclick="return layer.msg('请先登录!',{icon:6})" @endif data-apitype="5">立即游戏</a> </p>
                </dd>
               </dl> </li>
             @endif
