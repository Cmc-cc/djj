...
@if($_system_config->right_ad==1)
	<div id="fixd-right" class="fixscroll">
		...
		<a href="javascript:;">
			...
			<img class="fix_qrcode" style="left: 30px;bottom: 30px;width: 75px;height: 75px;" src="{{ $_system_config->wx_pic }}">
		</a>
...
<div class="hb"><a href="{{ route('web.red') }}" class="floathb" target="_blank"></a><span class="close-hb">关闭红包</span></div>
@endif
<script>
$(function(){
