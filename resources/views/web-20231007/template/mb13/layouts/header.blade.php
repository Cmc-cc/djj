...
<div class="header">
                ...
                <ul>
                    ...
                    <li class="lotterys @if($web_route == 'web.lottory') home @endif">
                        ...
                        @if(in_array('GBC', $_api_list))
                            <a href="javascript:;"
                               ...
                               @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>GB六合彩</a>
                        @endif						
                            ...
                            @endif
                                ...
                                @if(in_array('PG', $_api_list))
                                    <a href="javascript:;"
                                       ...
                                       @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>PG 鱼王争霸</a>
                                @endif
								 @if(in_array('PG', $_api_list))
                                    <a href="javascript:;"
                                       @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=PG&gamename=4004','','width=1024,height=768')"
                                       @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>PG 全民捕鱼</a>
                                @endif
                                @if(in_array('SA', $_api_list))
                                    <a href="javascript:;"
                                ...
                                @if(in_array('CQ9', $_api_list))
                                    <a href="javascript:;"
                                       @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=CQ9&gamename=AB3&game_code=AD01','','width=1024,height=768')"
                                       @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>CQ9捕鱼去喽</a>
                                @endif
                               ...
                               @if(in_array('PT', $_api_list))
                                ...
                                @if(in_array('PTS', $_api_list))
                                    <a href="javascript:;"
                                       ...
                                       @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>PTS捕鱼多福</a>
                                @endif
                                @if(in_array('PTS', $_api_list))
                                    <a href="javascript:;"
                                       @if($_member) onclick="javascript:window.open('{{ route('wg.playGame') }}?plat_type=PTS&gamename=sw_fuqsg','','width=1024,height=768')"
                                       @else onclick="return layer.msg('请先登录！',{icon:6})" @endif>PTS福气水果</a>
                                @endif
								 @if(in_array('FG', $_api_list))
                                    <a href="javascript:;"
                    ...
                    <li class="@if($web_route == 'web.poker') home @endif">
						...
						@if(in_array('TH', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=TH">天豪棋牌</a>
                        @endif
						@if(in_array('DSQP', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=DSQP">DS棋牌</a>
                        @endif
						
						@if(in_array('KY', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=KY">开元棋牌</a>
                        @endif
						@if(in_array('WGQP', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=WGQP">WG棋牌</a>
                        @endif
						
                         @if(in_array('MT', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=MT&gamename=MyGameLobby">美天棋牌</a>
                        @endif
						 @if(in_array('SW', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=SW&gamename=MyGameLobby">双赢棋牌</a>
                        @endif
						@if(in_array('FG', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=TH">天豪棋牌</a>
                        @endif
						@if(in_array('AP', $_api_list))
                                <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=761">棋乐游棋牌</a>
						@endif
                        @if(in_array('JS', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=JS">金龙棋牌</a>
                        @endif
						@if(in_array('LEG', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=LEG">乐游棋牌</a>
                        @endif
						@if(in_array('YG', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=YG">王者棋牌</a>
                        @endif
						@if(in_array('GG', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=GG">GG棋牌</a>
                        @endif
						
						@if(in_array('IMQP', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=IMQP">IM棋牌</a>
                        @endif
						
						 @if(in_array('AS', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=AS">天发棋牌</a>
                        @endif
						 @if(in_array('HG', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=HG">欢乐棋牌</a>
                        @endif						
						@if(in_array('NEWVG', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=NEWVG">VG棋牌</a>
                        @endif
						@if(in_array('NW', $_api_list))
                            <a target="_blank" href="{{ route('wg.playGame') }}?plat_type=NW">新世界棋牌</a>
                        @endif
    ...
    {{--BBIN 余额：<span class="brightYellow">{{ $_member->all_money }}</span>--}}
