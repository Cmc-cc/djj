                ...
                <div class="down">
                    ...
                    @else
                        ...
                        <p class="userImfo">
                            ...
                            系统余额：<font class="col-yellow money" id="user_money">{{ $_member->all_money }}</font><span>&nbsp;|&nbsp;</span>
							剩余码量：<font class="col-yellow money" id="user_money">{{ $_member->ml_money }}</font><span>&nbsp;|&nbsp;</span>
							

                            {{--投注金额：<font class="col-yellow" id="tz_money">3</font><br/>--}}

                            @if($_system_config->is_new_center ==1)
                                <a href="{{ route('member.userCenter') }}?type=6">会员中心</a><span>&nbsp;|&nbsp;</span>
							 <a href="{{ route('member.userCenter') }}?type=1">存取款</a><span>&nbsp;|&nbsp;</span>							
							   <a href="{{ route('member.userCenter') }}?type=4">账户记录</a><span>&nbsp;|&nbsp;</span>
    ...
    <div class="nav">
        <ul>
            ...
            <li id="LS-sports" class="game list1 @if($web_route == 'web.esports') on @endif">
                <a href="{{ route('web.esports') }}">体育赛事</a>
            </li>
            ...
            <li id="LS-Game" class="game LS-Game @if($web_route == 'web.catchFish') on @endif">
                <a href="{{ route('web.catchFish') }}">捕鱼游戏</a>
            </li>
